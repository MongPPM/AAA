(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const rm=()=>{};var Wc={};/**
 * @license
 ...
 */const Vu=function(n){const e=[];let t=0;for(let r=0;r<n.length;r++){let s=n.charCodeAt(r);s<128?e[t++]=s:s<2048?(e[t++]=s>>6|192,e[t++]=s&63|128):(s&64512)===55296&&r+1<n.length&&(n.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(n.charCodeAt(++r)&1023),e[t++]=s>>18|240,e[t++]=s>>12&63|128,e[t++]=s>>6&63|128,e[t++]=s&63|128):(e[t++]=s>>12|224,e[t++]=s>>6&63|128,e[t++]=s&63|128)}return e},sm=function(n){const e=[];let t=0,r=0;for(;t<n.length;){const s=n[t++];if(s<128)e[r++]=String.fromCharCode(s);else if(s>191&&s<224){const i=n[t++];e[r++]=String.fromCharCode((s&31)<<6|i&63)}else if(s>239&&s<365){const i=n[t++],a=n[t++],l=n[t++],u=((s&7)<<18|(i&63)<<12|(a&63)<<6|l&63)-65536;e[r++]=String.fromCharCode(55296+(u>>10)),e[r++]=String.fromCharCode(56320+(u&1023))}else{const i=n[t++],a=n[t++];e[r++]=String.fromCharCode((s&15)<<12|(i&63)<<6|a&63)}}return e.join("")},Lu={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<n.length;s+=3){const i=n[s],a=s+1<n.length,l=a?n[s+1]:0,u=s+2<n.length,d=u?n[s+2]:0,f=i>>2,g=(i&3)<<4|l>>4;let T=(l&15)<<2|d>>6,R=d&63;u||(R=64,a||(T=64)),r.push(t[f],t[g],t[T],t[R])}return r.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(Vu(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):sm(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<n.length;){const i=t[n.charAt(s++)],l=s<n.length?t[n.charAt(s)]:0;++s;const d=s<n.length?t[n.charAt(s)]:64;++s;const g=s<n.length?t[n.charAt(s)]:64;if(++s,i==null||l==null||d==null||g==null)throw new im;const T=i<<2|l>>4;if(r.push(T),d!==64){const R=l<<4&240|d>>2;if(r.push(R),g!==64){const k=d<<6&192|g;r.push(k)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class im extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const om=function(n){const e=Vu(n);return Lu.encodeByteArray(e,!0)},Os=function(n){return om(n).replace(/\./g,"")},xu=function(n){try{return Lu.decodeString(n,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cm=()=>am().__FIREBASE_DEFAULTS__,lm=()=>{if(typeof process>"u"||typeof Wc>"u")return;const n=Wc.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},um=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&xu(n[1]);return e&&JSON.parse(e)},ii=()=>{try{return rm()||cm()||lm()||um()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},Ou=n=>ii()?.emulatorHosts?.[n],hm=n=>{const e=Ou(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const r=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),r]:[e.substring(0,t),r]},Mu=()=>ii()?.config,Fu=n=>ii()?.[`_${n}`];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function mm(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Pe())}function gm(){const n=ii()?.forceEnvironment;if(n==="node")return!0;if(n==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function pm(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function ym(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function _m(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Em(){const n=Pe();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function vm(){return!gm()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Im(){try{return typeof indexedDB=="object"}catch{return!1}}function Tm(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{e(s.error?.message||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wm="FirebaseError";class _t extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=wm,Object.setPrototypeOf(this,_t.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Mr.prototype.create)}}class Mr{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?Am(i,r):"Error",l=`${this.serviceName}: ${a} (${s}).`;return new _t(s,l,r)}}function Am(n,e){return n.replace(bm,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const bm=/\{\$([^}]+)}/g;function Sm(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function sn(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],a=e[s];if(Kc(i)&&Kc(a)){if(!sn(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function Kc(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class km{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){const r=new dm;if(this.instancesDeferred.set(t,r),this.isInitialized(t)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:t});s&&r.resolve(s)}catch{}}return this.instancesDeferred.get(t).promise}getImmediate(e){const t=this.normalizeInstanceIdentifier(e?.identifier),r=e?.optional??!1;if(this.isInitialized(t)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:t})}catch(s){if(r)return null;throw s}else{if(r)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(Nm(e))try{this.getOrInitializeService({instanceIdentifier:Xt})}catch{}for(const[t,r]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(t);try{const i=this.getOrInitializeService({instanceIdentifier:s});r.resolve(i)}catch{}}}}clearInstance(e=Xt){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(t=>"INTERNAL"in t).map(t=>t.INTERNAL.delete()),...e.filter(t=>"_delete"in t).map(t=>t._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Xt){return this.instances.has(e)}getOptions(e=Xt){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:t={}}=e,r=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:r,options:t});for(const[i,a]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(i);r===l&&a.resolve(s)}return s}onInit(e,t){const r=this.normalizeInstanceIdentifier(t),s=this.onInitCallbacks.get(r)??new Set;s.add(e),this.onInitCallbacks.set(r,s);const i=this.instances.get(r);return i&&e(i,r),()=>{s.delete(e)}}invokeOnInitCallbacks(e,t){const r=this.onInitCallbacks.get(t);if(r)for(const s of r)try{s(e,t)}catch{}}getOrInitializeService({instanceIdentifier:e,options:t={}}){let r=this.instances.get(e);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:Dm(e),options:t}),this.instances.set(e,r),this.instancesOptions.set(e,t),this.invokeOnInitCallbacks(r,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,r)}catch{}return r||null}normalizeInstanceIdentifier(e=Xt){return this.component?this.component.multipleInstances?e:Xt:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Dm(n){return n===Xt?void 0:n}function Nm(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var K;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(K||(K={}));const Lm={debug:K.DEBUG,verbose:K.VERBOSE,info:K.INFO,warn:K.WARN,error:K.ERROR,silent:K.SILENT},xm=K.INFO,Om={[K.DEBUG]:"log",[K.VERBOSE]:"log",[K.INFO]:"info",[K.WARN]:"warn",[K.ERROR]:"error"},Mm=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),s=Om[e];if(s)console[s](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Ko{constructor(e){this.name=e,this._logLevel=xm,this._logHandler=Mm,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in K))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Lm[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,K.DEBUG,...e),this._logHandler(this,K.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,K.VERBOSE,...e),this._logHandler(this,K.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,K.INFO,...e),this._logHandler(this,K.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,K.WARN,...e),this._logHandler(this,K.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,K.ERROR,...e),this._logHandler(this,K.ERROR,...e)}}const Fm=(n,e)=>e.some(t=>n instanceof t);let Qc,Jc;function Bm(){return Qc||(Qc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Um(){return Jc||(Jc=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Uu=new WeakMap,yo=new WeakMap,$u=new WeakMap,no=new WeakMap,Qo=new WeakMap;function $m(n){const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("success",i),n.removeEventListener("error",a)},i=()=>{t(Ct(n.result)),s()},a=()=>{r(n.error),s()};n.addEventListener("success",i),n.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&Uu.set(t,n)}).catch(()=>{}),Qo.set(e,n),e}function jm(n){if(yo.has(n))return;const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("complete",i),n.removeEventListener("error",a),n.removeEventListener("abort",a)},i=()=>{t(),s()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",i),n.addEventListener("error",a),n.addEventListener("abort",a)});yo.set(n,e)}let _o={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return yo.get(n);if(e==="objectStoreNames")return n.objectStoreNames||$u.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return Ct(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function qm(n){_o=n(_o)}function Hm(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(ro(this),e,...t);return $u.set(r,e.sort?e.sort():[e]),Ct(r)}:Um().includes(n)?function(...e){return n.apply(ro(this),e),Ct(Uu.get(this))}:function(...e){return Ct(n.apply(ro(this),e))}}function zm(n){return typeof n=="function"?Hm(n):(n instanceof IDBTransaction&&jm(n),Fm(n,Bm())?new Proxy(n,_o):n)}function Ct(n){if(n instanceof IDBRequest)return $m(n);if(no.has(n))return no.get(n);const e=zm(n);return e!==n&&(no.set(n,e),Qo.set(e,n)),e}const ro=n=>Qo.get(n);function Gm(n,e,{blocked:t,upgrade:r,blocking:s,terminated:i}={}){const a=indexedDB.open(n,e),l=Ct(a);return r&&a.addEventListener("upgradeneeded",u=>{r(Ct(a.result),u.oldVersion,u.newVersion,Ct(a.transaction),u)}),t&&a.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),l.then(u=>{i&&u.addEventListener("close",()=>i()),s&&u.addEventListener("versionchange",d=>s(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const Wm=["get","getKey","getAll","getAllKeys","count"],Km=["put","add","delete","clear"],so=new Map;function Yc(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(so.get(e))return so.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,s=Km.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(s||Wm.includes(t)))return;const i=async function(a,...l){const u=this.transaction(a,s?"readwrite":"readonly");let d=u.store;return r&&(d=d.index(l.shift())),(await Promise.all([d[t](...l),s&&u.done]))[0]};return so.set(e,i),i}qm(n=>({...n,get:(e,t,r)=>Yc(e,t)||n.get(e,t,r),has:(e,t)=>!!Yc(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qm{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Jm(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function Jm(n){return n.getComponent()?.type==="VERSION"}const Eo="@firebase/app",Xc="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ft=new Ko("@firebase/app"),Ym="@firebase/app-compat",Xm="@firebase/analytics-compat",Zm="@firebase/analytics",eg="@firebase/app-check-compat",tg="@firebase/app-check",ng="@firebase/auth",rg="@firebase/auth-compat",sg="@firebase/database",ig="@firebase/data-connect",og="@firebase/database-compat",ag="@firebase/functions",cg="@firebase/functions-compat",lg="@firebase/installations",ug="@firebase/installations-compat",hg="@firebase/messaging",dg="@firebase/messaging-compat",fg="@firebase/performance",mg="@firebase/performance-compat",gg="@firebase/remote-config",pg="@firebase/remote-config-compat",yg="@firebase/storage",_g="@firebase/storage-compat",Eg="@firebase/firestore",vg="@firebase/ai",Ig="@firebase/firestore-compat",Tg="firebase",wg="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vo="[DEFAULT]",Ag={[Eo]:"fire-core",[Ym]:"fire-core-compat",[Zm]:"fire-analytics",[Xm]:"fire-analytics-compat",[tg]:"fire-app-check",[eg]:"fire-app-check-compat",[ng]:"fire-auth",[rg]:"fire-auth-compat",[sg]:"fire-rtdb",[ig]:"fire-data-connect",[og]:"fire-rtdb-compat",[ag]:"fire-fn",[cg]:"fire-fn-compat",[lg]:"fire-iid",[ug]:"fire-iid-compat",[hg]:"fire-fcm",[dg]:"fire-fcm-compat",[fg]:"fire-perf",[mg]:"fire-perf-compat",[gg]:"fire-rc",[pg]:"fire-rc-compat",[yg]:"fire-gcs",[_g]:"fire-gcs-compat",[Eg]:"fire-fst",[Ig]:"fire-fst-compat",[vg]:"fire-vertex","fire-js":"fire-js",[Tg]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $n=wg;function ju(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r={name:vo,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw kt.create("bad-app-name",{appName:String(s)});if(t||(t=Mu()),!t)throw kt.create("no-options");const i=Ms.get(s);if(i){if(sn(t,i.options)&&sn(r,i.config))return i;throw kt.create("duplicate-app",{appName:s})}const a=new Vm(s);for(const u of Io.values())a.addComponent(u);const l=new Rg(t,r,a);return Ms.set(s,l),l}function qu(n=vo){const e=Ms.get(n);if(!e&&n===vo&&Mu())return ju();if(!e)throw kt.create("no-app",{appName:n});return e}function Dt(n,e,t){let r=Ag[n]??n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&a.push("and"),i&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ft.warn(a.join(" "));return}Vn(new on(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pg="firebase-heartbeat-database",Cg=1,Rr="firebase-heartbeat-store";let io=null;function Hu(){return io||(io=Gm(Pg,Cg,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Rr)}catch(t){console.warn(t)}}}}).catch(n=>{throw kt.create("idb-open",{originalErrorMessage:n.message})})),io}async function kg(n){try{const t=(await Hu()).transaction(Rr),r=await t.objectStore(Rr).get(zu(n));return await t.done,r}catch(e){if(e instanceof _t)ft.warn(e.message);else{const t=kt.create("idb-get",{originalErrorMessage:e?.message});ft.warn(t.message)}}}async function el(n,e){try{const r=(await Hu()).transaction(Rr,"readwrite");await r.objectStore(Rr).put(e,zu(n)),await r.done}catch(t){if(t instanceof _t)ft.warn(t.message);else{const r=kt.create("idb-set",{originalErrorMessage:t?.message});ft.warn(r.message)}}}function zu(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dg=1024,Ng=30;class Vg{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new xg(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=tl();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(s=>s.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:t}),this._heartbeatsCache.heartbeats.length>Ng){const s=Og(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){ft.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=tl(),{heartbeatsToSend:t,unsentEntries:r}=Lg(this._heartbeatsCache.heartbeats),s=Os(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return ft.warn(e),""}}}function tl(){return new Date().toISOString().substring(0,10)}function Lg(n,e=Dg){const t=[];let r=n.slice();for(const s of n){const i=t.find(a=>a.agent===s.agent);if(i){if(i.dates.push(s.date),nl(t)>e){i.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),nl(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class xg{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Im()?Tm().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await kg(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return el(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return el(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function nl(n){return Os(JSON.stringify({version:2,heartbeats:n})).length}function Og(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let r=1;r<n.length;r++)n[r].date<t&&(t=n[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mg(n){Vn(new on("platform-logger",e=>new Qm(e),"PRIVATE")),Vn(new on("heartbeat",e=>new Vg(e),"PRIVATE")),Dt(Eo,Xc,n),Dt(Eo,Xc,"esm2020"),Dt("fire-js","")}Mg("");var Fg="firebase",Bg="12.13.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Dt(Fg,Bg,"app");function Gu(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Ug=Gu,Wu=new Mr("auth","Firebase",Gu());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fs=new Ko("@firebase/auth");function $g(n,...e){Fs.logLevel<=K.WARN&&Fs.warn(`Auth (${$n}): ${n}`,...e)}function As(n,...e){Fs.logLevel<=K.ERROR&&Fs.error(`Auth (${$n}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nt(n,...e){throw Xo(n,...e)}function He(n,...e){return Xo(n,...e)}function Yo(n,e,t){const r={...Ug(),[e]:t};return new Mr("auth","Firebase",r).create(e,{appName:n.name})}function tn(n){return Yo(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function jg(n,e,t){const r=t;if(!(e instanceof r))throw r.name!==e.constructor.name&&nt(n,"argument-error"),Yo(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Xo(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return Wu.create(n,...e)}function B(n,e,...t){if(!n)throw Xo(e,...t)}function at(n){const e="INTERNAL ASSERTION FAILED: "+n;throw As(e),new Error(e)}function mt(n,e){n||at(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function To(){return typeof self<"u"&&self.location?.href||""}function qg(){return rl()==="http:"||rl()==="https:"}function rl(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hg(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(qg()||ym()||"connection"in navigator)?navigator.onLine:!0}function zg(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ur{constructor(e,t){this.shortDelay=e,this.longDelay=t,mt(t>e,"Short delay should be less than long delay!"),this.isMobile=mm()||_m()}get(){return Hg()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wg=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Kg=new Ur(3e4,6e4);function ea(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function jn(n,e,t,r,s={}){return Qu(n,s,async()=>{let i={},a={};r&&(e==="GET"?a=r:i={body:JSON.stringify(r)});const l=Fr({key:n.config.apiKey,...a}).slice(1),u=await n._getAdditionalHeaders();u["Content-Type"]="application/json",n.languageCode&&(u["X-Firebase-Locale"]=n.languageCode);const d={method:e,headers:u,...i};return pm()||(d.referrerPolicy="no-referrer"),n.emulatorConfig&&Br(n.emulatorConfig.host)&&(d.credentials="include"),Ku.fetch()(await Ju(n,n.config.apiHost,t,l),d)})}async function Qu(n,e,t){n._canInitEmulator=!1;const r={...Gg,...e};try{const s=new Jg(n),i=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const a=await i.json();if("needConfirmation"in a)throw ps(n,"account-exists-with-different-credential",a);if(i.ok&&!("errorMessage"in a))return a;{const l=i.ok?a.errorMessage:a.error.message,[u,d]=l.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw ps(n,"credential-already-in-use",a);if(u==="EMAIL_EXISTS")throw ps(n,"email-already-in-use",a);if(u==="USER_DISABLED")throw ps(n,"user-disabled",a);const f=r[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw Yo(n,f,d);nt(n,f)}}catch(s){if(s instanceof _t)throw s;nt(n,"network-request-failed",{message:String(s)})}}async function Qg(n,e,t,r,s={}){const i=await jn(n,e,t,r,s);return"mfaPendingCredential"in i&&nt(n,"multi-factor-auth-required",{_serverResponse:i}),i}async function Ju(n,e,t,r){const s=`${e}${t}?${r}`,i=n,a=i.config.emulator?Zo(n.config,s):`${n.config.apiScheme}://${s}`;return Wg.includes(t)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(a).toString():a}class Jg{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(He(this.auth,"network-request-failed")),Kg.get())})}}function ps(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const s=He(n,e,r);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yg(n,e){return jn(n,"POST","/v1/accounts:delete",e)}async function Bs(n,e){return jn(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _r(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Xg(n,e=!1){const t=me(n),r=await t.getIdToken(e),s=ta(r);B(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,a=i?.sign_in_provider;return{claims:s,token:r,authTime:_r(oo(s.auth_time)),issuedAtTime:_r(oo(s.iat)),expirationTime:_r(oo(s.exp)),signInProvider:a||null,signInSecondFactor:i?.sign_in_second_factor||null}}function oo(n){return Number(n)*1e3}function ta(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return As("JWT malformed, contained fewer than 3 sections"),null;try{const s=xu(t);return s?JSON.parse(s):(As("Failed to decode base64 JWT payload"),null)}catch(s){return As("Caught error parsing JWT payload as JSON",s?.toString()),null}}function sl(n){const e=ta(n);return B(e,"internal-error"),B(typeof e.exp<"u","internal-error"),B(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof _t&&Zg(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Zg({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Us(n){const e=n.auth,t=await n.getIdToken(),r=await Pr(n,Bs(e,{idToken:t}));B(r?.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=s.providerUserInfo?.length?Yu(s.providerUserInfo):[],a=np(n.providerData,i),l=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!a?.length,d=l?u:!1,f={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new wo(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,f)}async function tp(n){const e=me(n);await Us(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function np(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Yu(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rp(n,e){const t=await Qu(n,{},async()=>{const r=Fr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,a=await Ju(n,s,"/v1/token",`key=${i}`),l=await n._getAdditionalHeaders();l["Content-Type"]="application/x-www-form-urlencoded";const u={method:"POST",headers:l,body:r};return n.emulatorConfig&&Br(n.emulatorConfig.host)&&(u.credentials="include"),Ku.fetch()(a,u)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function sp(n,e){return jn(n,"POST","/v2/accounts:revokeToken",ea(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xu{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Xu.type="NONE";const ol=Xu;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function al(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(nh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Zu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(sh(e))return"Blackberry";if(ih(e))return"Webos";if(eh(e))return"Safari";if((e.includes("chrome/")||th(e))&&!e.includes("edge/"))return"Chrome";if(rh(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if(r?.length===2)return r[1]}return"Other"}function Zu(n=Pe()){return/firefox\//i.test(n)}function eh(n=Pe()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function th(n=Pe()){return/crios\//i.test(n)}function nh(n=Pe()){return/iemobile/i.test(n)}function rh(n=Pe()){return/android/i.test(n)}function sh(n=Pe()){return/blackberry/i.test(n)}function ih(n=Pe()){return/webos/i.test(n)}function na(n=Pe()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function ip(n=Pe()){return na(n)&&!!window.navigator?.standalone}function op(){return Em()&&document.documentMode===10}function oh(n=Pe()){return na(n)||rh(n)||ih(n)||sh(n)||/windows phone/i.test(n)||nh(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ah(n,e=[]){let t;switch(n){case"Browser":t=al(Pe());break;case"Worker":t=`${al(Pe())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${$n}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ap{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,t){const r=i=>new Promise((a,l)=>{try{const u=e(i);a(u)}catch(u){l(u)}});r.onAbort=t,this.queue.push(r);const s=this.queue.length-1;return()=>{this.queue[s]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const t=[];try{for(const r of this.queue)await r(e),r.onAbort&&t.push(r.onAbort)}catch(r){t.reverse();for(const s of t)try{s()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:r?.message})}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cp(n,e={}){return jn(n,"GET","/v2/passwordPolicy",ea(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ra={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function dp(n){ra=n}function fp(n){return ra.loadJS(n)}function mp(){return ra.gapiScript}function gp(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pp(n,e){const t=Jo(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(sn(i,e??{}))return s;nt(s,"already-initialized")}return t.initialize({options:e})}function yp(n,e){const t=e?.persistence||[],r=(Array.isArray(t)?t:[t]).map(ct);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e?.popupRedirectResolver)}function _p(n,e,t){const r=oi(n);B(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=ch(e),{host:a,port:l}=Ep(e),u=l===null?"":`:${l}`,d={url:`${i}//${a}${u}/`},f=Object.freeze({host:a,port:l,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){B(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),B(sn(d,r.config.emulator)&&sn(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,Br(a)?Bu(`${i}//${a}${u}`):vp()}function ch(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Ep(n){const e=ch(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:ll(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:ll(a)}}}function ll(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function vp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lh{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return at("not implemented")}_getIdTokenResponse(e){return at("not implemented")}_linkToIdToken(e,t){return at("not implemented")}_getReauthenticationResolver(e){return at("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rn(n,e){return Qg(n,"POST","/v1/accounts:signInWithIdp",ea(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ot extends $r{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return an._fromParams({providerId:ot.PROVIDER_ID,signInMethod:ot.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return ot.credentialFromTaggedObject(e)}static credentialFromError(e){return ot.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return ot.credential(t,r)}catch{return null}}}ot.GOOGLE_SIGN_IN_METHOD="google.com";ot.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt extends $r{constructor(){super("github.com")}static credential(e){return an._fromParams({providerId:Rt.PROVIDER_ID,signInMethod:Rt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Rt.credentialFromTaggedObject(e)}static credentialFromError(e){return Rt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Rt.credential(e.oauthAccessToken)}catch{return null}}}Rt.GITHUB_SIGN_IN_METHOD="github.com";Rt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pt extends $r{constructor(){super("twitter.com")}static credential(e,t){return an._fromParams({providerId:Pt.PROVIDER_ID,signInMethod:Pt.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Pt.credentialFromTaggedObject(e)}static credentialFromError(e){return Pt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return Pt.credential(t,r)}catch{return null}}}Pt.TWITTER_SIGN_IN_METHOD="twitter.com";Pt.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $s extends _t{constructor(e,t,r,s){super(t.code,t.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,$s.prototype),this.customData={appName:e.name,tenantId:e.tenantId??void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,s){return new $s(e,t,r,s)}}function uh(n,e,t,r){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?$s._fromErrorAndOperation(n,i,e,r):i})}async function Tp(n,e,t=!1){const r=await Pr(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return Ln._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ap(n,e,t=!1){if($e(n.app))return Promise.reject(tn(n));const r="signIn",s=await uh(n,r,e),i=await Ln._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}function bp(n,e,t,r){return me(n).onIdTokenChanged(e,t,r)}function Sp(n,e,t){return me(n).beforeAuthStateChanged(e,t)}function Rp(n,e,t,r){return me(n).onAuthStateChanged(e,t,r)}function Pp(n){return me(n).signOut()}const js="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ye(){return window}function Lp(n){Ye().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gh(){return typeof Ye().WorkerGlobalScope<"u"&&typeof Ye().importScripts=="function"}async function xp(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Op(){return navigator?.serviceWorker?.controller||null}function Mp(){return gh()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eh(n,e){return e?ct(e):(B(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oa extends lh{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Rn(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Rn(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Rn(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Hp(n){return Ap(n.auth,new oa(n),n.bypassAuthState)}function zp(n){const{auth:e,user:t}=n;return B(t,e,"internal-error"),wp(t,new oa(n),n.bypassAuthState)}async function Gp(n){const{auth:e,user:t}=n;return B(t,e,"internal-error"),Tp(t,new oa(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vh{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:a,type:l}=e;if(a){this.reject(a);return}const u={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Hp;case"linkViaPopup":case"linkViaRedirect":return Gp;case"reauthViaPopup":case"reauthViaRedirect":return zp;default:nt(this.auth,"internal-error")}}resolve(e){mt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){mt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qp="pendingRedirect",Ss=new Map;class Jp extends vh{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Ss.get(this.auth._key());if(!e){try{const r=await Yp(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Ss.set(this.auth._key(),e)}return this.bypassAuthState||Ss.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Yp(n,e){const t=ey(e),r=Zp(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function Xp(n,e){Ss.set(n._key(),e)}function Zp(n){return ct(n._redirectPersistence)}function ey(n){return bs(Qp,n.config.apiKey,n.name)}async function ty(n,e,t=!1){if($e(n.app))return Promise.reject(tn(n));const r=oi(n),s=Eh(r,e),a=await new Jp(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ny=10*60*1e3;class ry{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(t=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!sy(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){if(e.error&&!Ih(e)){const r=e.error.code?.split("auth/")[1]||"internal-error";t.onError(He(this.auth,r))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const r=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=ny&&this.cachedEventUids.clear(),this.cachedEventUids.has(fl(e))}saveEventToCache(e){this.cachedEventUids.add(fl(e)),this.lastProcessedEventTime=Date.now()}}function fl(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function Ih({type:n,error:e}){return n==="unknown"&&e?.code==="auth/no-auth-event"}function sy(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Ih(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function iy(n,e={}){return jn(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uy=new Ur(3e4,6e4);function ml(){const n=Ye().___jsl;if(n?.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function hy(n){return new Promise((e,t)=>{function r(){ml(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{ml(),t(He(n,"network-request-failed"))},timeout:uy.get()})}if(Ye().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(Ye().gapi?.load)r();else{const s=gp("iframefcb");return Ye()[s]=()=>{gapi.load?r():t(He(n,"network-request-failed"))},fp(`${mp()}?onload=${s}`).catch(i=>t(i))}}).catch(e=>{throw Rs=null,e})}let Rs=null;function dy(n){return Rs=Rs||hy(n),Rs}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fy=new Ur(5e3,15e3),my="__/auth/iframe",gy="emulator/auth/iframe",py={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},yy=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function _y(n){const e=n.config;B(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Zo(e,gy):`https://${n.config.authDomain}/${my}`,r={apiKey:e.apiKey,appName:n.name,v:$n},s=yy.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${t}?${Fr(r).slice(1)}`}async function Ey(n){const e=await dy(n),t=Ye().gapi;return B(t,n,"internal-error"),e.open({where:document.body,url:_y(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:py,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const a=He(n,"network-request-failed"),l=Ye().setTimeout(()=>{i(a)},fy.get());function u(){Ye().clearTimeout(l),s(r)}r.ping(u).then(u,()=>{i(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vy={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Iy=500,Ty=600,wy="_blank",Ay="http://localhost";class gl{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function by(n,e,t,r=Iy,s=Ty){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let l="";const u={...vy,width:r.toString(),height:s.toString(),top:i,left:a},d=Pe().toLowerCase();t&&(l=th(d)?wy:t),Zu(d)&&(e=e||Ay,u.scrollbars="yes");const f=Object.entries(u).reduce((T,[R,k])=>`${T}${R}=${k},`,"");if(ip(d)&&l!=="_self")return Sy(e||"",l),new gl(null);const g=window.open(e||"",l,f);B(g,n,"popup-blocked");try{g.focus()}catch{}return new gl(g)}function Sy(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ry="__/auth/handler",Py="emulator/auth/handler",Cy=encodeURIComponent("fac");async function pl(n,e,t,r,s,i){B(n.config.authDomain,n,"auth-domain-config-required"),B(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:$n,eventId:s};if(e instanceof sa){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",Sm(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,g]of Object.entries({}))a[f]=g}if(e instanceof $r){const f=e.getScopes().filter(g=>g!=="");f.length>0&&(a.scopes=f.join(","))}n.tenantId&&(a.tid=n.tenantId);const l=a;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await n._getAppCheckToken(),d=u?`#${Cy}=${encodeURIComponent(u)}`:"";return`${ky(n)}?${Fr(l).slice(1)}${d}`}function ky({config:n}){return n.emulator?Zo(n,Py):`https://${n.authDomain}/${Ry}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ao="webStorageSupport";class Dy{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=mh,this._completeRedirectFn=ty,this._overrideRedirectResult=Xp}async _openPopup(e,t,r,s){mt(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const i=await pl(e,t,r,To(),s);return by(e,i,ia())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await pl(e,t,r,To(),s);return Lp(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(mt(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Ey(e),r=new ry(e);return t.register("authEvent",s=>(B(s?.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ao,{type:ao},s=>{const i=s?.[0]?.[ao];i!==void 0&&t(!!i),nt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=cy(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return oh()||eh()||na()}}const Ny=Dy;var yl="@firebase/auth",_l="1.13.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ly(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function xy(n){Vn(new on("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:l}=r.options;B(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const u={apiKey:a,authDomain:l,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:ah(n)},d=new hp(r,s,i,u);return yp(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),Vn(new on("auth-internal",e=>{const t=oi(e.getProvider("auth").getImmediate());return(r=>new Vy(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Dt(yl,_l,Ly(n)),Dt(yl,_l,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qn="12.13.0";function $y(n){qn=n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cn=new Ko("@firebase/firestore");function In(){return cn.logLevel}function L(n,...e){if(cn.logLevel<=K.DEBUG){const t=e.map(aa);cn.debug(`Firestore (${qn}): ${n}`,...t)}}function gt(n,...e){if(cn.logLevel<=K.ERROR){const t=e.map(aa);cn.error(`Firestore (${qn}): ${n}`,...t)}}function ln(n,...e){if(cn.logLevel<=K.WARN){const t=e.map(aa);cn.warn(`Firestore (${qn}): ${n}`,...t)}}function aa(n){if(typeof n=="string")return n;try{return function(t){return JSON.stringify(t)}(n)}catch{return n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,Ph(n,r,t)}function Ph(n,e,t){let r=`FIRESTORE (${qn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw gt(r),new Error(r)}function Y(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||Ph(e,s,r)}function $(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ch{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class jy{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Se.UNAUTHENTICATED))}shutdown(){}}class qy{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class Hy{constructor(e){this.t=e,this.currentUser=Se.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){Y(this.o===void 0,42304);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new Vt;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Vt,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const u=i;e.enqueueRetryable(async()=>{await u.promise,await s(this.currentUser)})},l=u=>{L("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(u=>l(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?l(u):(L("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Vt)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(L("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Y(typeof r.accessToken=="string",31837,{l:r}),new Ch(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Y(e===null||typeof e=="string",2055,{h:e}),new Se(e)}}class zy{constructor(e,t,r){this.P=e,this.T=t,this.I=r,this.type="FirstParty",this.user=Se.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const e=this.A();return e&&this.R.set("Authorization",e),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class Gy{constructor(e,t,r){this.P=e,this.T=t,this.I=r}getToken(){return Promise.resolve(new zy(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable(()=>t(Se.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Il{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Wy{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,$e(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){Y(this.o===void 0,3512);const r=i=>{i.error!=null&&L("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.m;return this.m=i.token,L("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{L("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):L("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new Il(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(Y(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new Il(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cr=-1;function Zy(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=U.fromTimestamp(r===1e9?new re(t+1,0):new re(t,r));return new xt(s,O.empty(),e)}function e_(n){return new xt(n.readTime,n.key,Cr)}class xt{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new xt(U.min(),O.empty(),Cr)}static max(){return new xt(U.max(),O.empty(),Cr)}}function t_(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=O.comparator(n.documentKey,e.documentKey),t!==0?t:z(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hn(n){if(n.code!==S.FAILED_PRECONDITION||n.message!==n_)throw n;L("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const la=-1;function hi(n){return n==null}function Hs(n){return n===0&&1/n==-1/0}function i_(n){return typeof n=="number"&&Number.isInteger(n)&&!Hs(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nh="";function o_(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Rl(e)),e=a_(n.get(t),e);return Rl(e)}function a_(n,e){let t=e;const r=n.length;for(let s=0;s<r;s++){const i=n.charAt(s);switch(i){case"\0":t+="";break;case Nh:t+="";break;default:t+=i}}return t}function Rl(n){return n+Nh+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pl(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function qt(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Vh(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xh="server_timestamp",Oh="__type__",Mh="__previous_value__",Fh="__local_write_time__";function ua(n){return(n?.mapValue?.fields||{})[Oh]?.stringValue===xh}function di(n){const e=n.mapValue.fields[Mh];return ua(e)?di(e):e}function kr(n){const e=Ot(n.mapValue.fields[Fh].timestampValue);return new re(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class l_{constructor(e,t,r,s,i,a,l,u,d,f,g){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=i,this.forceLongPolling=a,this.autoDetectLongPolling=l,this.longPollingOptions=u,this.useFetchStreams=d,this.isUsingEmulator=f,this.apiKey=g}}const Ro="(default)";class Dr{constructor(e,t){this.projectId=e,this.database=t||Ro}static empty(){return new Dr("","")}get isDefaultDatabase(){return this.database===Ro}isEqual(e){return e instanceof Dr&&e.projectId===this.projectId&&e.database===this.database}}function u_(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new V(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Dr(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vr{constructor(e,t="asc"){this.field=e,this.dir=t}}function m_(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jh{}class de extends jh{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new p_(e,t,r):t==="array-contains"?new E_(e,r):t==="in"?new v_(e,r):t==="not-in"?new I_(e,r):t==="array-contains-any"?new T_(e,r):new de(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new y_(e,r):new __(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(On(t,this.value)):t!==null&&Ft(this.value)===Ft(t)&&this.matchesComparison(On(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return F(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Ge extends jh{constructor(e,t){super(),this.filters=e,this.op=t,this.Pe=null}static create(e,t){return new Ge(e,t)}matches(e){return qh(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function qh(n){return n.op==="and"}function Hh(n){return g_(n)&&qh(n)}function g_(n){for(const e of n.filters)if(e instanceof Ge)return!1;return!0}function ko(n){if(n instanceof de)return n.field.canonicalString()+n.op.toString()+Mn(n.value);if(Hh(n))return n.filters.map(e=>ko(e)).join(",");{const e=n.filters.map(t=>ko(t)).join(",");return`${n.op}(${e})`}}function zh(n,e){return n instanceof de?function(r,s){return s instanceof de&&r.op===s.op&&r.field.isEqual(s.field)&&rt(r.value,s.value)}(n,e):n instanceof Ge?function(r,s){return s instanceof Ge&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce((i,a,l)=>i&&zh(a,s.filters[l]),!0):!1}(n,e):void F(19439)}function Gh(n){return n instanceof de?function(t){return`${t.field.canonicalString()} ${t.op} ${Mn(t.value)}`}(n):n instanceof Ge?function(t){return t.op.toString()+" {"+t.getFilters().map(Gh).join(" ,")+"}"}(n):"Filter"}class p_ extends de{constructor(e,t,r){super(e,t,r),this.key=O.fromName(r.referenceValue)}matches(e){const t=O.comparator(e.key,this.key);return this.matchesComparison(t)}}class y_ extends de{constructor(e,t){super(e,"in",t),this.keys=Wh("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class __ extends de{constructor(e,t){super(e,"not-in",t),this.keys=Wh("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function Wh(n,e){return(e.arrayValue?.values||[]).map(t=>O.fromName(t.referenceValue))}class E_ extends de{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return ha(t)&&Nr(t.arrayValue,this.value)}}class v_ extends de{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&Nr(this.value.arrayValue,t)}}class I_ extends de{constructor(e,t){super(e,"not-in",t)}matches(e){if(Nr(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!Nr(this.value.arrayValue,t)}}class T_ extends de{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!ha(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>Nr(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w_{constructor(e,t=null,r=[],s=[],i=null,a=null,l=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=i,this.startAt=a,this.endAt=l,this.Te=null}}function Ml(n,e=null,t=[],r=[],s=null,i=null,a=null){return new w_(n,e,t,r,s,i,a)}function da(n){const e=$(n);if(e.Te===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(r=>ko(r)).join(","),t+="|ob:",t+=e.orderBy.map(r=>function(i){return i.field.canonicalString()+i.dir}(r)).join(","),hi(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(r=>Mn(r)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(r=>Mn(r)).join(",")),e.Te=t}return e.Te}function fa(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!m_(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!zh(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Ol(n.startAt,e.startAt)&&Ol(n.endAt,e.endAt)}function Do(n){return O.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k_=new oe(O.comparator);function pt(){return k_}const Yh=new oe(O.comparator);function mr(...n){let e=Yh;for(const t of n)e=e.insert(t.key,t);return e}function Xh(n){let e=Yh;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function en(){return Ir()}function Zh(){return Ir()}function Ir(){return new gn(n=>n.toString(),(n,e)=>n.isEqual(e))}const D_=new oe(O.comparator),N_=new ye(O.comparator);function G(...n){let e=N_;for(const t of n)e=e.add(t);return e}const V_=new ye(z);function L_(){return V_}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ma(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Hs(e)?"-0":e}}function ed(n){return{integerValue:""+n}}function x_(n,e){return i_(e)?ed(e):ma(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pi{constructor(){this._=void 0}}function O_(n,e,t){return n instanceof Ws?function(s,i){const a={fields:{[Oh]:{stringValue:xh},[Fh]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&ua(i)&&(i=di(i)),i&&(a.fields[Mh]=i),{mapValue:a}}(t,e):n instanceof Lr?nd(n,e):n instanceof xr?rd(n,e):function(s,i){const a=td(s,i),l=Bl(a)+Bl(s.Ae);return Co(a)&&Co(s.Ae)?ed(l):ma(s.serializer,l)}(n,e)}function M_(n,e,t){return n instanceof Lr?nd(n,e):n instanceof xr?rd(n,e):t}function td(n,e){return n instanceof Ks?function(r){return Co(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Ws extends pi{}class Lr extends pi{constructor(e){super(),this.elements=e}}function nd(n,e){const t=sd(e);for(const r of n.elements)t.some(s=>rt(s,r))||t.push(r);return{arrayValue:{values:t}}}class xr extends pi{constructor(e){super(),this.elements=e}}function rd(n,e){let t=sd(e);for(const r of n.elements)t=t.filter(s=>!rt(s,r));return{arrayValue:{values:t}}}class Ks extends pi{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function Bl(n){return le(n.integerValue||n.doubleValue)}function sd(n){return ha(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}function F_(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof Lr&&s instanceof Lr||r instanceof xr&&s instanceof xr?xn(r.elements,s.elements,rt):r instanceof Ks&&s instanceof Ks?rt(r.Ae,s.Ae):r instanceof Ws&&s instanceof Ws}(n.transform,e.transform)}class B_{constructor(e,t){this.version=e,this.transformResults=t}}class Ne{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Ne}static exists(e){return new Ne(void 0,e)}static updateTime(e){return new Ne(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Ds(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class yi{}function id(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new _i(n.key,Ne.none()):new Hr(n.key,n.data,Ne.none());{const t=n.data,r=xe.empty();let s=new ye(Te.comparator);for(let i of e.fields)if(!s.has(i)){let a=t.field(i);a===null&&i.length>1&&(i=i.popLast(),a=t.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new Ht(n.key,r,new Fe(s.toArray()),Ne.none())}}function U_(n,e,t){n instanceof Hr?function(s,i,a){const l=s.value.clone(),u=$l(s.fieldTransforms,i,a.transformResults);l.setAll(u),i.convertToFoundDocument(a.version,l).setHasCommittedMutations()}(n,e,t):n instanceof Ht?function(s,i,a){if(!Ds(s.precondition,i))return void i.convertToUnknownDocument(a.version);const l=$l(s.fieldTransforms,i,a.transformResults),u=i.data;u.setAll(od(s)),u.setAll(l),i.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(n,e,t):function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function Tr(n,e,t,r){return n instanceof Hr?function(i,a,l,u){if(!Ds(i.precondition,a))return l;const d=i.value.clone(),f=jl(i.fieldTransforms,u,a);return d.setAll(f),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null}(n,e,t,r):n instanceof Ht?function(i,a,l,u){if(!Ds(i.precondition,a))return l;const d=jl(i.fieldTransforms,u,a),f=a.data;return f.setAll(od(i)),f.setAll(d),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),l===null?null:l.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(g=>g.field))}(n,e,t,r):function(i,a,l){return Ds(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):l}(n,e,t)}function $_(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),i=td(r.transform,s||null);i!=null&&(t===null&&(t=xe.empty()),t.set(r.field,i))}return t||null}function Ul(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&xn(r,s,(i,a)=>F_(i,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Hr extends yi{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Ht extends yi{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function od(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function $l(n,e,t){const r=new Map;Y(n.length===t.length,32656,{Ve:t.length,de:n.length});for(let s=0;s<t.length;s++){const i=n[s],a=i.transform,l=e.data.field(i.field);r.set(i.field,M_(a,l,t[s]))}return r}function jl(n,e,t){const r=new Map;for(const s of n){const i=s.transform,a=t.data.field(s.field);r.set(s.field,O_(i,a,e))}return r}class _i extends yi{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class j_ extends yi{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fE{constructor(e){this.yt=e}}function mE(n){const e=aE({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Vo(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gE{constructor(){this.bn=new pE}addToCollectionParentIndex(e,t){return this.bn.add(t),P.resolve()}getCollectionParents(e,t){return P.resolve(this.bn.getEntries(t))}addFieldIndex(e,t){return P.resolve()}deleteFieldIndex(e,t){return P.resolve()}deleteAllFieldIndexes(e){return P.resolve()}createTargetIndexes(e,t){return P.resolve()}getDocumentsMatchingTarget(e,t){return P.resolve(null)}getIndexType(e,t){return P.resolve(0)}getFieldIndexes(e,t){return P.resolve([])}getNextCollectionGroupToUpdate(e){return P.resolve(null)}getMinOffset(e,t){return P.resolve(xt.min())}getMinOffsetFromCollectionGroup(e,t){return P.resolve(xt.min())}updateCollectionGroup(e,t,r){return P.resolve()}updateIndexEntries(e,t){return P.resolve()}}class pE{constructor(){this.index={}}add(e){const t=e.lastSegment(),r=e.popLast(),s=this.index[t]||new ye(ee.comparator),i=!s.has(r);return this.index[t]=s.add(r),i}has(e){const t=e.lastSegment(),r=e.popLast(),s=this.index[t];return s&&s.has(r)}getEntries(e){return(this.index[e]||new ye(ee.comparator)).toArray()}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Le.DEFAULT_COLLECTION_PERCENTILE=10,Le.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Le.DEFAULT=new Le(_d,Le.DEFAULT_COLLECTION_PERCENTILE,Le.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Le.DISABLED=new Le(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class TE{constructor(){this.changes=new gn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Re.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?P.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AE{constructor(e,t,r,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(s=>(r=s,this.remoteDocumentCache.getEntry(e,t))).next(s=>(r!==null&&Tr(r.mutation,s,Fe.empty(),re.now()),s))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,G()).next(()=>r))}getLocalViewOfDocuments(e,t,r=G()){const s=en();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,r).next(i=>{let a=mr();return i.forEach((l,u)=>{a=a.insert(l,u.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=en();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,G()))}populateOverlays(e,t,r){const s=[];return r.forEach(i=>{t.has(i)||s.push(i)}),this.documentOverlayCache.getOverlays(e,s).next(i=>{i.forEach((a,l)=>{t.set(a,l)})})}computeViews(e,t,r,s){let i=pt();const a=Ir(),l=function(){return Ir()}();return t.forEach((u,d)=>{const f=r.get(d.key);s.has(d.key)&&(f===void 0||f.mutation instanceof Ht)?i=i.insert(d.key,d):f!==void 0?(a.set(d.key,f.mutation.getFieldMask()),Tr(f.mutation,d,f.mutation.getFieldMask(),re.now())):a.set(d.key,Fe.empty())}),this.recalculateAndSaveOverlays(e,i).next(u=>(u.forEach((d,f)=>a.set(d,f)),t.forEach((d,f)=>l.set(d,new wE(f,a.get(d)??null))),l))}recalculateAndSaveOverlays(e,t){const r=Ir();let s=new oe((a,l)=>a-l),i=G();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const l of a)l.keys().forEach(u=>{const d=t.get(u);if(d===null)return;let f=r.get(u)||Fe.empty();f=l.applyToLocalView(d,f),r.set(u,f);const g=(s.get(l.batchId)||G()).add(u);s=s.insert(l.batchId,g)})}).next(()=>{const a=[],l=s.getReverseIterator();for(;l.hasNext();){const u=l.getNext(),d=u.key,f=u.value,g=Zh();f.forEach(T=>{if(!i.has(T)){const R=id(t.get(T),r.get(T));R!==null&&g.set(T,R),i=i.add(T)}}),a.push(this.documentOverlayCache.saveOverlays(e,d,g))}return P.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,s){return b_(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Kh(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,s):this.getDocumentsMatchingCollectionQuery(e,t,r,s)}getNextDocuments(e,t,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,s).next(i=>{const a=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,s-i.size):P.resolve(en());let l=Cr,u=i;return a.next(d=>P.forEach(d,(f,g)=>(l<g.largestBatchId&&(l=g.largestBatchId),i.get(f)?P.resolve():this.remoteDocumentCache.getEntry(e,f).next(T=>{u=u.insert(f,T)}))).next(()=>this.populateOverlays(e,d,i)).next(()=>this.computeViews(e,u,d,G())).next(f=>({batchId:l,changes:Xh(f)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new O(t)).next(r=>{let s=mr();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(e,t,r,s){const i=t.collectionGroup;let a=mr();return this.indexManager.getCollectionParents(e,i).next(l=>P.forEach(l,u=>{const d=function(g,T){return new Gn(T,null,g.explicitOrderBy.slice(),g.filters.slice(),g.limit,g.limitType,g.startAt,g.endAt)}(t,u.child(i));return this.getDocumentsMatchingCollectionQuery(e,d,r,s).next(f=>{f.forEach((g,T)=>{a=a.insert(g,T)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,s){let i;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(i=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,i,s))).next(a=>{i.forEach((u,d)=>{const f=d.getKey();a.get(f)===null&&(a=a.insert(f,Re.newInvalidDocument(f)))});let l=mr();return a.forEach((u,d)=>{const f=i.get(u);f!==void 0&&Tr(f.mutation,d,Fe.empty(),re.now()),gi(t,d)&&(l=l.insert(u,d))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class SE{constructor(){this.overlays=new oe(O.comparator),this.Lr=new Map}getOverlay(e,t){return P.resolve(this.overlays.get(t))}getOverlays(e,t){const r=en();return P.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,t,r){return r.forEach((s,i)=>{this.St(e,t,i)}),P.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.Lr.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.Lr.delete(r)),P.resolve()}getOverlaysForCollection(e,t,r){const s=en(),i=t.length+1,a=new O(t.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const u=l.getNext().value,d=u.getKey();if(!t.isPrefixOf(d.path))break;d.path.length===i&&u.largestBatchId>r&&s.set(u.getKey(),u)}return P.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let i=new oe((d,f)=>d-f);const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===t&&d.largestBatchId>r){let f=i.get(d.largestBatchId);f===null&&(f=en(),i=i.insert(d.largestBatchId,f)),f.set(d.getKey(),d)}}const l=en(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((d,f)=>l.set(d,f)),!(l.size()>=s)););return P.resolve(l)}St(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.Lr.get(s.largestBatchId).delete(r.key);this.Lr.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new H_(t,r));let i=this.Lr.get(t);i===void 0&&(i=G(),this.Lr.set(t,i)),this.Lr.set(t,i.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RE{constructor(){this.sessionToken=we.EMPTY_BYTE_STRING}getSessionToken(e){return P.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,P.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CE{constructor(e){this.ti=e,this.docs=function(){return new oe(O.comparator)}(),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,t){const r=t.key,s=this.docs.get(r),i=s?s.size:0,a=this.ti(t);return this.docs=this.docs.insert(r,{document:t.mutableCopy(),size:a}),this.size+=a-i,this.indexManager.addToCollectionParentIndex(e,r.path.popLast())}removeEntry(e){const t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){const r=this.docs.get(t);return P.resolve(r?r.document.mutableCopy():Re.newInvalidDocument(t))}getEntries(e,t){let r=pt();return t.forEach(s=>{const i=this.docs.get(s);r=r.insert(s,i?i.document.mutableCopy():Re.newInvalidDocument(s))}),P.resolve(r)}getDocumentsMatchingQuery(e,t,r,s){let i=pt();const a=t.path,l=new O(a.child("__id-9223372036854775808__")),u=this.docs.getIteratorFrom(l);for(;u.hasNext();){const{key:d,value:{document:f}}=u.getNext();if(!a.isPrefixOf(d.path))break;d.path.length>a.length+1||t_(e_(f),r)<=0||(s.has(f.key)||gi(t,f))&&(i=i.insert(f.key,f.mutableCopy()))}return P.resolve(i)}getAllFromCollectionGroup(e,t,r,s){F(9500)}ni(e,t){return P.forEach(this.docs,r=>t(r))}newChangeBuffer(e){return new kE(this)}getSize(e){return P.resolve(this.size)}}class kE extends TE{constructor(e){super(),this.Mr=e}applyChanges(e){const t=[];return this.changes.forEach((r,s)=>{s.isValidDocument()?t.push(this.Mr.addEntry(e,s)):this.Mr.removeEntry(r)}),P.waitFor(t)}getFromCache(e,t){return this.Mr.getEntry(e,t)}getAllFromCache(e,t){return this.Mr.getEntries(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ed{constructor(e,t){this._i={},this.overlays={},this.ai=new ui(0),this.ui=!1,this.ui=!0,this.ci=new RE,this.referenceDelegate=e(this),this.li=new DE(this),this.indexManager=new gE,this.remoteDocumentCache=function(s){return new CE(s)}(r=>this.referenceDelegate.hi(r)),this.serializer=new fE(t),this.Pi=new bE(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.ui=!1,Promise.resolve()}get started(){return this.ui}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new SE,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this._i[e.toKey()];return r||(r=new PE(t,this.referenceDelegate),this._i[e.toKey()]=r),r}getGlobalsCache(){return this.ci}getTargetCache(){return this.li}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Pi}runTransaction(e,t,r){L("MemoryPersistence","Starting transaction:",e);const s=new NE(this.ai.next());return this.referenceDelegate.Ti(),r(s).next(i=>this.referenceDelegate.Ii(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Ei(e,t){return P.or(Object.values(this._i).map(r=>()=>r.containsKey(e,t)))}}class NE extends r_{constructor(e){super(),this.currentSequenceNumber=e}}class Ea{constructor(e){this.persistence=e,this.Ri=new _a,this.Ai=null}static Vi(e){return new Ea(e)}get di(){if(this.Ai)return this.Ai;throw F(60996)}addReference(e,t,r){return this.Ri.addReference(r,t),this.di.delete(r.toString()),P.resolve()}removeReference(e,t,r){return this.Ri.removeReference(r,t),this.di.add(r.toString()),P.resolve()}markPotentiallyOrphaned(e,t){return this.di.add(t.toString()),P.resolve()}removeTarget(e,t){this.Ri.Gr(t.targetId).forEach(s=>this.di.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.di.add(i.toString()))}).next(()=>r.removeTargetData(e,t))}Ti(){this.Ai=new Set}Ii(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return P.forEach(this.di,r=>{const s=O.fromPath(r);return this.mi(e,s).next(i=>{i||t.removeEntry(s,U.min())})}).next(()=>(this.Ai=null,t.apply(e)))}updateLimboDocument(e,t){return this.mi(e,t).next(r=>{r?this.di.delete(t.toString()):this.di.add(t.toString())})}hi(e){return 0}mi(e,t){return P.or([()=>P.resolve(this.Ri.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ei(e,t)])}}class Js{constructor(e,t){this.persistence=e,this.fi=new gn(r=>o_(r.path),(r,s)=>r.isEqual(s)),this.garbageCollector=IE(this,t)}static Vi(e,t){return new Js(e,t)}Ti(){}Ii(e){return P.resolve()}forEachTarget(e,t){return this.persistence.getTargetCache().forEachTarget(e,t)}dr(e){const t=this.pr(e);return this.persistence.getTargetCache().getTargetCount(e).next(r=>t.next(s=>r+s))}pr(e){let t=0;return this.mr(e,r=>{t++}).next(()=>t)}mr(e,t){return P.forEach(this.fi,(r,s)=>this.wr(e,r,s).next(i=>i?P.resolve():t(s)))}removeTargets(e,t,r){return this.persistence.getTargetCache().removeTargets(e,t,r)}removeOrphanedDocuments(e,t){let r=0;const s=this.persistence.getRemoteDocumentCache(),i=s.newChangeBuffer();return s.ni(e,a=>this.wr(e,a,t).next(l=>{l||(r++,i.removeEntry(a,U.min()))})).next(()=>i.apply(e)).next(()=>r)}markPotentiallyOrphaned(e,t){return this.fi.set(t,e.currentSequenceNumber),P.resolve()}removeTarget(e,t){const r=t.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,r)}addReference(e,t,r){return this.fi.set(r,e.currentSequenceNumber),P.resolve()}removeReference(e,t,r){return this.fi.set(r,e.currentSequenceNumber),P.resolve()}updateLimboDocument(e,t){return this.fi.set(t,e.currentSequenceNumber),P.resolve()}hi(e){let t=e.key.toString().length;return e.isFoundDocument()&&(t+=Cs(e.data.value)),t}wr(e,t,r){return P.or([()=>this.persistence.Ei(e,t),()=>this.persistence.getTargetCache().containsKey(e,t),()=>{const s=this.fi.get(t);return P.resolve(s!==void 0&&s>r)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uo="RestConnection",GE={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class WE{get Ko(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.qo=t+"://"+e.host,this.Uo=`projects/${r}/databases/${s}`,this.$o=this.databaseId.database===Ro?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Wo(e,t,r,s,i){const a=Bo(),l=this.Qo(e,t.toUriEncodedString());L(uo,`Sending RPC '${e}' ${a}:`,l,r);const u={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(u,s,i);const{host:d}=new URL(l),f=Br(d);return this.zo(e,l,u,r,f).then(g=>(L(uo,`Received RPC '${e}' ${a}: `,g),g),g=>{throw ln(uo,`RPC '${e}' ${a} failed with error: `,g,"url: ",l,"request:",r),g})}jo(e,t,r,s,i,a){return this.Wo(e,t,r,s,i)}Go(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+qn}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,i)=>e[i]=s),r&&r.headers.forEach((s,i)=>e[i]=s)}Qo(e,t){const r=GE[e];let s=`${this.qo}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const be="WebChannelConnection",hr=(n,e,t)=>{n.listen(e,r=>{try{t(r)}catch(s){setTimeout(()=>{throw s},0)}})};class Pn extends WE{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!Pn.c_){const e=Sh();hr(e,bh.STAT_EVENT,t=>{t.stat===bo.PROXY?L(be,"STAT_EVENT: detected buffering proxy"):t.stat===bo.NOPROXY&&L(be,"STAT_EVENT: detected no buffering proxy")}),Pn.c_=!0}}zo(e,t,r,s,i){const a=Bo();return new Promise((l,u)=>{const d=new wh;d.setWithCredentials(!0),d.listenOnce(Ah.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case Ps.NO_ERROR:const g=d.getResponseJson();L(be,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(g)),l(g);break;case Ps.TIMEOUT:L(be,`RPC '${e}' ${a} timed out`),u(new V(S.DEADLINE_EXCEEDED,"Request time out"));break;case Ps.HTTP_ERROR:const T=d.getStatus();if(L(be,`RPC '${e}' ${a} failed with status:`,T,"response text:",d.getResponseText()),T>0){let R=d.getResponseJson();Array.isArray(R)&&(R=R[0]);const k=R?.error;if(k&&k.status&&k.message){const N=function(j){const W=j.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(W)>=0?W:S.UNKNOWN}(k.status);u(new V(N,k.message))}else u(new V(S.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new V(S.UNAVAILABLE,"Connection failed."));break;default:F(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{L(be,`RPC '${e}' ${a} completed.`)}});const f=JSON.stringify(s);L(be,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",f,r,15)})}T_(e,t,r){const s=Bo(),i=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Go(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const d=i.join("");L(be,`Creating RPC '${e}' stream ${s}: ${d}`,l);const f=a.createWebChannel(d,l);this.I_(f);let g=!1,T=!1;const R=new KE({Jo:k=>{T?L(be,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(g||(L(be,`Opening RPC '${e}' stream ${s} transport.`),f.open(),g=!0),L(be,`RPC '${e}' stream ${s} sending:`,k),f.send(k))},Ho:()=>f.close()});return hr(f,fr.EventType.OPEN,()=>{T||(L(be,`RPC '${e}' stream ${s} transport opened.`),R.i_())}),hr(f,fr.EventType.CLOSE,()=>{T||(T=!0,L(be,`RPC '${e}' stream ${s} transport closed`),R.o_(),this.E_(f))}),hr(f,fr.EventType.ERROR,k=>{T||(T=!0,ln(be,`RPC '${e}' stream ${s} transport errored. Name:`,k.name,"Message:",k.message),R.o_(new V(S.UNAVAILABLE,"The operation could not be completed")))}),hr(f,fr.EventType.MESSAGE,k=>{if(!T){const N=k.data[0];Y(!!N,16349);const C=N,j=C?.error||C[0]?.error;if(j){L(be,`RPC '${e}' stream ${s} received error:`,j);const W=j.status;let X=function(M){const E=ue[M];if(E!==void 0)return ad(E)}(W),ve=j.message;W==="NOT_FOUND"&&ve.includes("database")&&ve.includes("does not exist")&&ve.includes(this.databaseId.database)&&ln(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),X===void 0&&(X=S.INTERNAL,ve="Unknown error status: "+W+" with message "+j.message),T=!0,R.o_(new V(X,ve)),f.close()}else L(be,`RPC '${e}' stream ${s} received:`,N),R.__(N)}}),Pn.u_(),setTimeout(()=>{R.s_()},0),R}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter(t=>t===e)}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return Rh()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function QE(n){return new Pn(n)}function ho(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ei(n){return new Z_(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const st="RemoteStore";class nv{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Map,this.Ra=new Map,this.Aa=new Bt(1e3),this.Va=new Bt(1001),this.da=new Set,this.ma=[],this.fa=i,this.fa.Mo(a=>{r.enqueueAndForget(async()=>{pn(this)&&(L(st,"Restarting streams for network reachability change."),await async function(u){const d=$(u);d.da.add(4),await Wr(d),d.ga.set("Unknown"),d.da.delete(4),await vi(d)}(this))})}),this.ga=new tv(r,s)}}async function vi(n){if(pn(n))for(const e of n.ma)await e(!0)}async function Wr(n){for(const e of n.ma)await e(!1)}function Uo(n,e){return n.Ea.get(e)||void 0}function Ad(n,e){const t=$(n),r=Uo(t,e.targetId);if(r!==void 0&&t.Ia.has(r))return;const s=function(l,u){const d=Uo(l,u);d!==void 0&&l.Ra.delete(d);const f=function(T,R){return R%2!=0?T.Va.next():T.Aa.next()}(l,u);return l.Ea.set(u,f),l.Ra.set(f,u),f}(t,e.targetId);L(st,"remoteStoreListen mapping SDK target ID to remote",e.targetId,s);const i=new lt(e.target,s,e.purpose,e.sequenceNumber,e.snapshotVersion,e.lastLimboFreeSnapshotVersion,e.resumeToken);t.Ia.set(s,i),ba(t)?Aa(t):Wn(t).O_()&&wa(t,i)}function Ta(n,e){const t=$(n),r=Wn(t),s=Uo(t,e);L(st,"remoteStoreUnlisten removing mapping of SDK target ID to remote",e,s),t.Ia.delete(s),t.Ea.delete(e),t.Ra.delete(s),r.O_()&&bd(t,s),t.Ia.size===0&&(r.O_()?r.L_():pn(t)&&t.ga.set("Unknown"))}function wa(n,e){if(n.pa.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(U.min())>0){const t=n.Ra.get(e.targetId);if(t===void 0)return void L(st,"SDK target ID not found for remote ID: "+e.targetId);const r=n.remoteSyncer.getRemoteKeysForTarget(t).size;e=e.withExpectedCount(r)}Wn(n).Z_(e)}function bd(n,e){n.pa.$e(e),Wn(n).X_(e)}function Aa(n){n.pa=new Q_({getRemoteKeysForTarget:e=>{const t=n.Ra.get(e);return t!==void 0?n.remoteSyncer.getRemoteKeysForTarget(t):G()},At:e=>n.Ia.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),Wn(n).start(),n.ga.ua()}function ba(n){return pn(n)&&!Wn(n).x_()&&n.Ia.size>0}function pn(n){return $(n).da.size===0}function Sd(n){n.pa=void 0}async function rv(n){n.ga.set("Online")}async function sv(n){n.Ia.forEach((e,t)=>{wa(n,e)})}async function iv(n,e){Sd(n),ba(n)?(n.ga.ha(e),Aa(n)):n.ga.set("Unknown")}async function ov(n,e,t){if(n.ga.set("Online"),e instanceof ld&&e.state===2&&e.cause)try{await async function(s,i){const a=i.cause;for(const l of i.targetIds){if(s.Ia.has(l)){const u=s.Ra.get(l);u!==void 0&&(await s.remoteSyncer.rejectListen(u,a),s.Ea.delete(u),s.Ra.delete(l)),s.Ia.delete(l)}s.pa.removeTarget(l)}}(n,e)}catch(r){L(st,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Ys(n,r)}else if(e instanceof Ns?n.pa.Xe(e):e instanceof cd?n.pa.st(e):n.pa.tt(e),!t.isEqual(U.min()))try{const r=await Id(n.localStore);t.compareTo(r)>=0&&await function(i,a){const l=i.pa.Tt(a);l.targetChanges.forEach((d,f)=>{if(d.resumeToken.approximateByteSize()>0){const g=i.Ia.get(f);g&&i.Ia.set(f,g.withResumeToken(d.resumeToken,a))}}),l.targetMismatches.forEach((d,f)=>{const g=i.Ia.get(d);if(!g)return;i.Ia.set(d,g.withResumeToken(we.EMPTY_BYTE_STRING,g.snapshotVersion)),bd(i,d);const T=new lt(g.target,d,f,g.sequenceNumber);wa(i,T)});const u=function(f,g){const T=new Map;g.targetChanges.forEach((k,N)=>{const C=f.Ra.get(N);C!==void 0&&T.set(C,k)});let R=new oe(z);return g.targetMismatches.forEach((k,N)=>{const C=f.Ra.get(k);C!==void 0&&(R=R.insert(C,N))}),new zr(g.snapshotVersion,T,R,g.documentUpdates,g.resolvedLimboDocuments)}(i,l);return i.remoteSyncer.applyRemoteEvent(u)}(n,t)}catch(r){L(st,"Failed to raise snapshot:",r),await Ys(n,r)}}async function Ys(n,e,t){if(!zn(e))throw e;n.da.add(1),await Wr(n),n.ga.set("Offline"),t||(t=()=>Id(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{L(st,"Retrying IndexedDB access"),await t(),n.da.delete(1),await vi(n)})}function Rd(n,e){return e().catch(t=>Ys(n,t,e))}async function Ii(n){const e=$(n),t=Ut(e);let r=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:la;for(;av(e);)try{const s=await $E(e.localStore,r);if(s===null){e.Ta.length===0&&t.L_();break}r=s.batchId,cv(e,s)}catch(s){await Ys(e,s)}Pd(e)&&Cd(e)}function av(n){return pn(n)&&n.Ta.length<10}function cv(n,e){n.Ta.push(e);const t=Ut(n);t.O_()&&t.Y_&&t.ea(e.mutations)}function Pd(n){return pn(n)&&!Ut(n).x_()&&n.Ta.length>0}function Cd(n){Ut(n).start()}async function lv(n){Ut(n).ra()}async function uv(n){const e=Ut(n);for(const t of n.Ta)e.ea(t.mutations)}async function hv(n,e,t){const r=n.Ta.shift(),s=ga.from(r,e,t);await Rd(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await Ii(n)}async function dv(n,e){e&&Ut(n).Y_&&await async function(r,s){if(function(a){return G_(a)&&a!==S.ABORTED}(s.code)){const i=r.Ta.shift();Ut(r).B_(),await Rd(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Ii(r)}}(n,e),Pd(n)&&Cd(n)}async function nu(n,e){const t=$(n);t.asyncQueue.verifyOperationInProgress(),L(st,"RemoteStore received new credentials");const r=pn(t);t.da.add(3),await Wr(t),r&&t.ga.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.da.delete(3),await vi(t)}async function fv(n,e){const t=$(n);e?(t.da.delete(2),await vi(t)):e||(t.da.add(2),await Wr(t),t.ga.set("Unknown"))}function Wn(n){return n.ya||(n.ya=function(t,r,s){const i=$(t);return i.sa(),new JE(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{Zo:rv.bind(null,n),Yo:sv.bind(null,n),t_:iv.bind(null,n),H_:ov.bind(null,n)}),n.ma.push(async e=>{e?(n.ya.B_(),ba(n)?Aa(n):n.ga.set("Unknown")):(await n.ya.stop(),Sd(n))})),n.ya}function Ut(n){return n.wa||(n.wa=function(t,r,s){const i=$(t);return i.sa(),new YE(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),Yo:lv.bind(null,n),t_:dv.bind(null,n),ta:uv.bind(null,n),na:hv.bind(null,n)}),n.ma.push(async e=>{e?(n.wa.B_(),await Ii(n)):(await n.wa.stop(),n.Ta.length>0&&(L(st,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))})),n.wa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vd{constructor(e){this.key=e}}class Ld{constructor(e){this.key=e}}class _v{constructor(e,t){this.query=e,this.tu=t,this.nu=null,this.hasCachedResults=!1,this.current=!1,this.ru=G(),this.mutatedKeys=G(),this.iu=Jh(e),this.su=new Cn(this.iu)}get ou(){return this.tu}_u(e,t){const r=t?t.au:new ru,s=t?t.su:this.su;let i=t?t.mutatedKeys:this.mutatedKeys,a=s,l=!1;const u=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,d=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((f,g)=>{const T=s.get(f),R=gi(this.query,g)?g:null,k=!!T&&this.mutatedKeys.has(T.key),N=!!R&&(R.hasLocalMutations||this.mutatedKeys.has(R.key)&&R.hasCommittedMutations);let C=!1;T&&R?T.data.isEqual(R.data)?k!==N&&(r.track({type:3,doc:R}),C=!0):this.uu(T,R)||(r.track({type:2,doc:R}),C=!0,(u&&this.iu(R,u)>0||d&&this.iu(R,d)<0)&&(l=!0)):!T&&R?(r.track({type:0,doc:R}),C=!0):T&&!R&&(r.track({type:1,doc:T}),C=!0,(u||d)&&(l=!0)),C&&(R?(a=a.add(R),i=N?i.add(f):i.delete(f)):(a=a.delete(f),i=i.delete(f)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const f=this.query.limitType==="F"?a.last():a.first();a=a.delete(f.key),i=i.delete(f.key),r.track({type:1,doc:f})}return{su:a,au:r,bs:l,mutatedKeys:i}}uu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const i=this.su;this.su=e.su,this.mutatedKeys=e.mutatedKeys;const a=e.au.Da();a.sort((f,g)=>function(R,k){const N=C=>{switch(C){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return F(20277,{Vt:C})}};return N(R)-N(k)}(f.type,g.type)||this.iu(f.doc,g.doc)),this.cu(r),s=s??!1;const l=t&&!s?this.lu():[],u=this.ru.size===0&&this.current&&!s?1:0,d=u!==this.nu;return this.nu=u,a.length!==0||d?{snapshot:new Fn(this.query,e.su,i,a,e.mutatedKeys,u===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),hu:l}:{hu:l}}Oa(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({su:this.su,au:new ru,mutatedKeys:this.mutatedKeys,bs:!1},!1)):{hu:[]}}Pu(e){return!this.tu.has(e)&&!!this.su.has(e)&&!this.su.get(e).hasLocalMutations}cu(e){e&&(e.addedDocuments.forEach(t=>this.tu=this.tu.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.tu=this.tu.delete(t)),this.current=e.current)}lu(){if(!this.current)return[];const e=this.ru;this.ru=G(),this.su.forEach(r=>{this.Pu(r.key)&&(this.ru=this.ru.add(r.key))});const t=[];return e.forEach(r=>{this.ru.has(r)||t.push(new Ld(r))}),this.ru.forEach(r=>{e.has(r)||t.push(new Vd(r))}),t}Tu(e){this.tu=e.ks,this.ru=G();const t=this._u(e.documents);return this.applyChanges(t,!0)}Iu(){return Fn.fromInitialDocuments(this.query,this.su,this.mutatedKeys,this.nu===0,this.hasCachedResults)}}const Ca="SyncEngine";class Ev{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class vv{constructor(e){this.key=e,this.Eu=!1}}class Iv{constructor(e,t,r,s,i,a){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.Ru={},this.Au=new gn(l=>Qh(l),mi),this.Vu=new Map,this.du=new Set,this.mu=new oe(O.comparator),this.fu=new Map,this.gu=new _a,this.pu={},this.yu=new Map,this.wu=Bt.ar(),this.onlineState="Unknown",this.Su=void 0}get isPrimaryClient(){return this.Su===!0}}async function Tv(n,e,t=!0){const r=Ud(n);let s;const i=r.Au.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.Iu()):s=await xd(r,e,t,!0),s}async function wv(n,e){const t=Ud(n);await xd(t,e,!0,!1)}async function xd(n,e,t,r){const s=await jE(n.localStore,Xe(e)),i=s.targetId,a=n.sharedClientState.addLocalQueryTarget(i,t);let l;return r&&(l=await Av(n,e,i,a==="current",s.resumeToken)),n.isPrimaryClient&&t&&Ad(n.remoteStore,s),l}async function Av(n,e,t,r,s){n.bu=(g,T,R)=>async function(N,C,j,W){let X=C.view._u(j);X.bs&&(X=await Yl(N.localStore,C.query,!1).then(({documents:E})=>C.view._u(E,X)));const ve=W&&W.targetChanges.get(C.targetId),Oe=W&&W.targetMismatches.get(C.targetId)!=null,M=C.view.applyChanges(X,N.isPrimaryClient,ve,Oe);return au(N,C.targetId,M.hu),M.snapshot}(n,g,T,R);const i=await Yl(n.localStore,e,!0),a=new _v(e,i.ks),l=a._u(i.documents),u=Gr.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),d=a.applyChanges(l,n.isPrimaryClient,u);au(n,t,d.hu);const f=new Ev(e,t,a);return n.Au.set(e,f),n.Vu.has(t)?n.Vu.get(t).push(e):n.Vu.set(t,[e]),d.snapshot}async function bv(n,e,t){const r=$(n),s=r.Au.get(e),i=r.Vu.get(s.targetId);if(i.length>1)return r.Vu.set(s.targetId,i.filter(a=>!mi(a,e))),void r.Au.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await Fo(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),t&&Ta(r.remoteStore,s.targetId),jo(r,s.targetId)}).catch(Hn)):(jo(r,s.targetId),await Fo(r.localStore,s.targetId,!0))}async function Sv(n,e){const t=$(n),r=t.Au.get(e),s=t.Vu.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),Ta(t.remoteStore,r.targetId))}async function Rv(n,e,t){const r=Lv(n);try{const s=await function(a,l){const u=$(a),d=re.now(),f=l.reduce((R,k)=>R.add(k.key),G());let g,T;return u.persistence.runTransaction("Locally write mutations","readwrite",R=>{let k=pt(),N=G();return u.xs.getEntries(R,f).next(C=>{k=C,k.forEach((j,W)=>{W.isValidDocument()||(N=N.add(j))})}).next(()=>u.localDocuments.getOverlayedDocuments(R,k)).next(C=>{g=C;const j=[];for(const W of l){const X=$_(W,g.get(W.key).overlayedDocument);X!=null&&j.push(new Ht(W.key,X,$h(X.value.mapValue),Ne.exists(!0)))}return u.mutationQueue.addMutationBatch(R,d,j,l)}).next(C=>{T=C;const j=C.applyToLocalDocumentSet(g,N);return u.documentOverlayCache.saveOverlays(R,C.batchId,j)})}).then(()=>({batchId:T.batchId,changes:Xh(g)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),function(a,l,u){let d=a.pu[a.currentUser.toKey()];d||(d=new oe(z)),d=d.insert(l,u),a.pu[a.currentUser.toKey()]=d}(r,s.batchId,t),await Kr(r,s.changes),await Ii(r.remoteStore)}catch(s){const i=Ra(s,"Failed to persist write");t.reject(i)}}async function Od(n,e){const t=$(n);try{const r=await BE(t.localStore,e);e.targetChanges.forEach((s,i)=>{const a=t.fu.get(i);a&&(Y(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?a.Eu=!0:s.modifiedDocuments.size>0?Y(a.Eu,14607):s.removedDocuments.size>0&&(Y(a.Eu,42227),a.Eu=!1))}),await Kr(t,r,e)}catch(r){await Hn(r)}}function ou(n,e,t){const r=$(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.Au.forEach((i,a)=>{const l=a.view.Oa(e);l.snapshot&&s.push(l.snapshot)}),function(a,l){const u=$(a);u.onlineState=l;let d=!1;u.queries.forEach((f,g)=>{for(const T of g.va)T.Oa(l)&&(d=!0)}),d&&Pa(u)}(r.eventManager,e),s.length&&r.Ru.H_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function Pv(n,e,t){const r=$(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.fu.get(e),i=s&&s.key;if(i){let a=new oe(O.comparator);a=a.insert(i,Re.newNoDocument(i,U.min()));const l=G().add(i),u=new zr(U.min(),new Map,new oe(z),a,l);await Od(r,u),r.mu=r.mu.remove(i),r.fu.delete(e),ka(r)}else await Fo(r.localStore,e,!1).then(()=>jo(r,e,t)).catch(Hn)}async function Cv(n,e){const t=$(n),r=e.batch.batchId;try{const s=await FE(t.localStore,e);Fd(t,r,null),Md(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await Kr(t,s)}catch(s){await Hn(s)}}async function kv(n,e,t){const r=$(n);try{const s=await function(a,l){const u=$(a);return u.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let f;return u.mutationQueue.lookupMutationBatch(d,l).next(g=>(Y(g!==null,37113),f=g.keys(),u.mutationQueue.removeMutationBatch(d,g))).next(()=>u.mutationQueue.performConsistencyCheck(d)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(d,f,l)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,f)).next(()=>u.localDocuments.getDocuments(d,f))})}(r.localStore,e);Fd(r,e,t),Md(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await Kr(r,s)}catch(s){await Hn(s)}}function Md(n,e){(n.yu.get(e)||[]).forEach(t=>{t.resolve()}),n.yu.delete(e)}function Fd(n,e,t){const r=$(n);let s=r.pu[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(t?i.reject(t):i.resolve(),s=s.remove(e)),r.pu[r.currentUser.toKey()]=s}}function jo(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Vu.get(e))n.Au.delete(r),t&&n.Ru.Du(r,t);n.Vu.delete(e),n.isPrimaryClient&&n.gu.Gr(e).forEach(r=>{n.gu.containsKey(r)||Bd(n,r)})}function Bd(n,e){n.du.delete(e.path.canonicalString());const t=n.mu.get(e);t!==null&&(Ta(n.remoteStore,t),n.mu=n.mu.remove(e),n.fu.delete(t),ka(n))}function au(n,e,t){for(const r of t)r instanceof Vd?(n.gu.addReference(r.key,e),Dv(n,r)):r instanceof Ld?(L(Ca,"Document no longer in limbo: "+r.key),n.gu.removeReference(r.key,e),n.gu.containsKey(r.key)||Bd(n,r.key)):F(19791,{Cu:r})}function Dv(n,e){const t=e.key,r=t.path.canonicalString();n.mu.get(t)||n.du.has(r)||(L(Ca,"New document in limbo: "+t),n.du.add(r),ka(n))}function ka(n){for(;n.du.size>0&&n.mu.size<n.maxConcurrentLimboResolutions;){const e=n.du.values().next().value;n.du.delete(e);const t=new O(ee.fromString(e)),r=n.wu.next();n.fu.set(r,new vv(t)),n.mu=n.mu.insert(t,r),Ad(n.remoteStore,new lt(Xe(fi(t.path)),r,"TargetPurposeLimboResolution",ui.ce))}}async function Kr(n,e,t){const r=$(n),s=[],i=[],a=[];r.Au.isEmpty()||(r.Au.forEach((l,u)=>{a.push(r.bu(u,e,t).then(d=>{if((d||t)&&r.isPrimaryClient){const f=d?!d.fromCache:t?.targetChanges.get(u.targetId)?.current;r.sharedClientState.updateQueryState(u.targetId,f?"current":"not-current")}if(d){s.push(d);const f=va.Es(u.targetId,d);i.push(f)}}))}),await Promise.all(a),r.Ru.H_(s),await async function(u,d){const f=$(u);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",g=>P.forEach(d,T=>P.forEach(T.Ts,R=>f.persistence.referenceDelegate.addReference(g,T.targetId,R)).next(()=>P.forEach(T.Is,R=>f.persistence.referenceDelegate.removeReference(g,T.targetId,R)))))}catch(g){if(!zn(g))throw g;L(Ia,"Failed to update sequence numbers: "+g)}for(const g of d){const T=g.targetId;if(!g.fromCache){const R=f.vs.get(T),k=R.snapshotVersion,N=R.withLastLimboFreeSnapshotVersion(k);f.vs=f.vs.insert(T,N)}}}(r.localStore,i))}async function Nv(n,e){const t=$(n);if(!t.currentUser.isEqual(e)){L(Ca,"User change. New user:",e.toKey());const r=await vd(t.localStore,e);t.currentUser=e,function(i,a){i.yu.forEach(l=>{l.forEach(u=>{u.reject(new V(S.CANCELLED,a))})}),i.yu.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Kr(t,r.Ns)}}function Vv(n,e){const t=$(n),r=t.fu.get(e);if(r&&r.Eu)return G().add(r.key);{let s=G();const i=t.Vu.get(e);if(!i)return s;for(const a of i){const l=t.Au.get(a);s=s.unionWith(l.view.ou)}return s}}function Ud(n){const e=$(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=Od.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=Vv.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=Pv.bind(null,e),e.Ru.H_=pv.bind(null,e.eventManager),e.Ru.Du=yv.bind(null,e.eventManager),e}function Lv(n){const e=$(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=Cv.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=kv.bind(null,e),e}class Xs{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Ei(e.databaseInfo.databaseId),this.sharedClientState=this.Mu(e),this.persistence=this.xu(e),await this.persistence.start(),this.localStore=this.Ou(e),this.gcScheduler=this.Nu(e,this.localStore),this.indexBackfillerScheduler=this.Bu(e,this.localStore)}Nu(e,t){return null}Bu(e,t){return null}Ou(e){return ME(this.persistence,new LE,e.initialUser,this.serializer)}xu(e){return new Ed(Ea.Vi,this.serializer)}Mu(e){return new HE}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Xs.provider={build:()=>new Xs};class xv extends Xs{constructor(e){super(),this.cacheSizeBytes=e}Nu(e,t){Y(this.persistence.referenceDelegate instanceof Js,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new EE(r,e.asyncQueue,t)}xu(e){const t=this.cacheSizeBytes!==void 0?Le.withCacheSize(this.cacheSizeBytes):Le.DEFAULT;return new Ed(r=>Js.Vi(r,t),this.serializer)}}class qo{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>ou(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=Nv.bind(null,this.syncEngine),await fv(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new gv}()}createDatastore(e){const t=Ei(e.databaseInfo.databaseId),r=QE(e.databaseInfo);return ev(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,s,i,a,l){return new nv(r,s,i,a,l)}(this.localStore,this.datastore,e.asyncQueue,t=>ou(this.syncEngine,t,0),function(){return eu.v()?new eu:new zE}())}createSyncEngine(e,t){return function(s,i,a,l,u,d,f){const g=new Iv(s,i,a,l,u,d);return f&&(g.Su=!0),g}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){await async function(t){const r=$(t);L(st,"RemoteStore shutting down."),r.da.add(5),await Wr(r),r.fa.shutdown(),r.ga.set("Unknown")}(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}qo.provider={build:()=>new qo};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $d{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.ku(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.ku(this.observer.error,e):gt("Uncaught Error in snapshot listener:",e.toString()))}Ku(){this.muted=!0}ku(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jv="ComponentProvider",lu=new Map;function qv(n,e,t,r,s){return new l_(n,e,t,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,qd(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hd="firestore.googleapis.com",uu=!0;class hu{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new V(S.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=Hd,this.ssl=uu}else this.host=e.host,this.ssl=e.ssl??uu;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=_d;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<yE)throw new V(S.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}Xy("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=qd(e.experimentalLongPollingOptions??{}),function(r){if(r.timeoutSeconds!==void 0){if(isNaN(r.timeoutSeconds))throw new V(S.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (must not be NaN)`);if(r.timeoutSeconds<5)throw new V(S.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (minimum allowed value is 5)`);if(r.timeoutSeconds>30)throw new V(S.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(r,s){return r.timeoutSeconds===s.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class Ti{constructor(e,t,r,s){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=r,this._app=s,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new hu({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new V(S.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new V(S.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new hu(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=function(r){if(!r)return new jy;switch(r.type){case"firstParty":return new Gy(r.sessionIndex||"0",r.iamToken||null,r.authTokenFactory||null);case"provider":return r.client;default:throw new V(S.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const r=lu.get(t);r&&(L(jv,"Removing Datastore"),lu.delete(t),r.terminate())}(this),Promise.resolve()}}function Hv(n,e,t,r={}){n=Be(n,Ti);const s=Br(e),i=n._getSettings(),a={...i,emulatorOptions:n._getEmulatorOptions()},l=`${e}:${t}`;s&&Bu(`https://${l}`),i.host!==Hd&&i.host!==l&&ln("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const u={...i,host:l,ssl:s,emulatorOptions:r};if(!sn(u,a)&&(n._setSettings(u),r.mockUserToken)){let d,f;if(typeof r.mockUserToken=="string")d=r.mockUserToken,f=Se.MOCK_USER;else{d=fm(r.mockUserToken,n._app?.options.projectId);const g=r.mockUserToken.sub||r.mockUserToken.user_id;if(!g)throw new V(S.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");f=new Se(g)}n._authCredentials=new qy(new Ch(d,f))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wv=/^__.*__$/;class Kv{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new Ht(e,this.data,this.fieldMask,t,this.fieldTransforms):new Hr(e,this.data,t,this.fieldTransforms)}}class Gd{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new Ht(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function Wd(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw F(40011,{dataSource:n})}}class Na{constructor(e,t,r,s,i,a){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=s,i===void 0&&this.fc(),this.fieldTransforms=i||[],this.fieldMask=a||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}i(e){return new Na({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}yc(e){const t=this.path?.child(e),r=this.i({path:t,arrayElement:!1});return r.wc(e),r}Sc(e){const t=this.path?.child(e),r=this.i({path:t,arrayElement:!1});return r.fc(),r}bc(e){return this.i({path:void 0,arrayElement:!0})}Dc(e){return Zs(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}fc(){if(this.path)for(let e=0;e<this.path.length;e++)this.wc(this.path.get(e))}wc(e){if(e.length===0)throw this.Dc("Document fields must not be empty");if(Wd(this.dataSource)&&Wv.test(e))throw this.Dc('Document fields cannot begin and end with "__"')}}class Qv{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||Ei(e)}V(e,t,r,s=!1){return new Na({dataSource:e,methodName:t,targetDoc:r,path:Te.emptyPath(),arrayElement:!1,hasConverter:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Qr(n){const e=n._freezeSettings(),t=Ei(n._databaseId);return new Qv(n._databaseId,!!e.ignoreUndefinedProperties,t)}function Va(n,e,t,r,s,i={}){const a=n.V(i.merge||i.mergeFields?2:0,e,t,s);La("Data must be an object, but it was:",a,r);const l=Jd(r,a);let u,d;if(i.merge)u=new Fe(a.fieldMask),d=a.fieldTransforms;else if(i.mergeFields){const f=[];for(const g of i.mergeFields){const T=Bn(e,g,t);if(!a.contains(T))throw new V(S.INVALID_ARGUMENT,`Field '${T}' is specified in your field mask but missing from your input data.`);Zd(f,T)||f.push(T)}u=new Fe(f),d=a.fieldTransforms.filter(g=>u.covers(g.field))}else u=null,d=a.fieldTransforms;return new Kv(new xe(l),u,d)}class bi extends Da{_toFieldTransform(e){if(e.dataSource!==2)throw e.dataSource===1?e.Dc(`${this._methodName}() can only appear at the top level of your update data`):e.Dc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof bi}}function Kd(n,e,t,r){const s=n.V(1,e,t);La("Data must be an object, but it was:",s,r);const i=[],a=xe.empty();qt(r,(u,d)=>{const f=Xd(e,u,t);d=me(d);const g=s.Sc(f);if(d instanceof bi)i.push(f);else{const T=Jr(d,g);T!=null&&(i.push(f),a.set(f,T))}});const l=new Fe(i);return new Gd(a,l,s.fieldTransforms)}function Qd(n,e,t,r,s,i){const a=n.V(1,e,t),l=[Bn(e,r,t)],u=[s];if(i.length%2!=0)throw new V(S.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let T=0;T<i.length;T+=2)l.push(Bn(e,i[T])),u.push(i[T+1]);const d=[],f=xe.empty();for(let T=l.length-1;T>=0;--T)if(!Zd(d,l[T])){const R=l[T];let k=u[T];k=me(k);const N=a.Sc(R);if(k instanceof bi)d.push(R);else{const C=Jr(k,N);C!=null&&(d.push(R),f.set(R,C))}}const g=new Fe(d);return new Gd(f,g,a.fieldTransforms)}function Jv(n,e,t,r=!1){return Jr(t,n.V(r?4:3,e))}function Jr(n,e){if(Yd(n=me(n)))return La("Unsupported field value:",e,n),Jd(n,e);if(n instanceof Da)return function(r,s){if(!Wd(s.dataSource))throw s.Dc(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.Dc(`${r._methodName}() is not currently supported inside arrays`);const i=r._toFieldTransform(s);i&&s.fieldTransforms.push(i)}(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.Dc("Nested arrays are not supported");return function(r,s){const i=[];let a=0;for(const l of r){let u=Jr(l,s.bc(a));u==null&&(u={nullValue:"NULL_VALUE"}),i.push(u),a++}return{arrayValue:{values:i}}}(n,e)}return function(r,s){if((r=me(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return x_(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const i=re.fromDate(r);return{timestampValue:Qs(s.serializer,i)}}if(r instanceof re){const i=new re(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:Qs(s.serializer,i)}}if(r instanceof et)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof Ue)return{bytesValue:ud(s.serializer,r._byteString)};if(r instanceof ce){const i=s.databaseId,a=r.firestore._databaseId;if(!a.isEqual(i))throw s.Dc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:ya(r.firestore._databaseId||s.databaseId,r._key.path)}}if(r instanceof ze)return function(a,l){const u=a instanceof ze?a.toArray():a;return{mapValue:{fields:{[Bh]:{stringValue:Uh},[zs]:{arrayValue:{values:u.map(f=>{if(typeof f!="number")throw l.Dc("VectorValues must only contain numeric values.");return ma(l.serializer,f)})}}}}}}(r,s);if(yd(r))return r._toProto(s.serializer);throw s.Dc(`Unsupported field value: ${li(r)}`)}(n,e)}function Jd(n,e){const t={};return Vh(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):qt(n,(r,s)=>{const i=Jr(s,e.yc(r));i!=null&&(t[r]=i)}),{mapValue:{fields:t}}}function Yd(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof re||n instanceof et||n instanceof Ue||n instanceof ce||n instanceof Da||n instanceof ze||yd(n))}function La(n,e,t){if(!Yd(t)||!Dh(t)){const r=li(t);throw r==="an object"?e.Dc(n+" a custom object"):e.Dc(n+" "+r)}}function Bn(n,e,t){if((e=me(e))instanceof Ai)return e._internalPath;if(typeof e=="string")return Xd(n,e);throw Zs("Field path arguments must be of type string or ",n,!1,void 0,t)}const Yv=new RegExp("[~\\*/\\[\\]]");function Xd(n,e,t){if(e.search(Yv)>=0)throw Zs(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new Ai(...e.split("."))._internalPath}catch{throw Zs(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Zs(n,e,t,r,s){const i=r&&!r.isEmpty(),a=s!==void 0;let l=`Function ${e}() called with invalid data`;t&&(l+=" (via `toFirestore()`)"),l+=". ";let u="";return(i||a)&&(u+=" (found",i&&(u+=` in field ${r}`),a&&(u+=` in document ${s}`),u+=")"),new V(S.INVALID_ARGUMENT,l+n+u)}function Zd(n,e){return n.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ef extends Xv{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ue(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ce(this.firestore,null,t)}}const gu="@firebase/firestore",pu="4.14.1";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tf{constructor(e,t,r,s,i){this._firestore=e,this._userDataWriter=t,this._key=r,this._document=s,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new ce(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new Zv(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}_fieldsProto(){return this._document?.data.clone().value.mapValue.fields??void 0}get(e){if(this._document){const t=this._document.data.field(Bn("DocumentSnapshot.get",e));if(t!==null)return this._userDataWriter.convertValue(t)}}}class Zv extends tf{data(){return super.data()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
Upgrade to Pro for unlimited scanning.`,"slip.viewSlip":"View slip ↗","slip.viewBtn":"View slip","cat.salary":"Salary","cat.freelance":"Freelance","cat.investment":"Investment","cat.gift":"Gift/Bonus","cat.other_in":"Other Income","cat.food":"Food","cat.transport":"Transport","cat.shopping":"Shopping","cat.utilities":"Utilities","cat.health":"Health","cat.entertainment":"Entertainment","cat.education":"Education","cat.rent":"Rent/Home","cat.other_ex":"Other Expense","dev.switchFree":"🔧 Dev: Pro → Switch Free","dev.switchPro":"🔧 Dev: Free → Switch Pro","dev.toasted":"🔧 Dev: Switched to "}};let Ri=(()=>{const n=localStorage.getItem("mf_lang");return n==="th"||n==="en"?n:navigator.language?.toLowerCase().startsWith("th")?"th":"en"})();function go(){return Ri}function hI(n){n!=="th"&&n!=="en"||(Ri=n,localStorage.setItem("mf_lang",n))}function x(n,e){let t=Iu[Ri]?.[n]??Iu.th[n]??n;if(e)for(const[r,s]of Object.entries(e))t=t.replaceAll(`{${r}}`,s);return t}function un(){return x("locale")}function Tu(){document.querySelectorAll("[data-i18n]").forEach(e=>{e.textContent=x(e.dataset.i18n)}),document.querySelectorAll("[data-i18n-html]").forEach(e=>{e.innerHTML=x(e.dataset.i18nHtml).replace(/\n/g,"<br>")}),document.querySelectorAll("[data-i18n-ph]").forEach(e=>{e.placeholder=x(e.dataset.i18nPh)});const n=document.getElementById("select-language");n&&(n.value=Ri)}const hn={income:[{id:"salary",emoji:"💼"},{id:"freelance",emoji:"💻"},{id:"investment",emoji:"📈"},{id:"gift",emoji:"🎁"},{id:"other_in",emoji:"💰"}],expense:[{id:"food",emoji:"🍜"},{id:"transport",emoji:"🚗"},{id:"shopping",emoji:"🛍️"},{id:"utilities",emoji:"💡"},{id:"health",emoji:"🏥"},{id:"entertainment",emoji:"🎮"},{id:"education",emoji:"📚"},{id:"rent",emoji:"🏠"},{id:"other_ex",emoji:"📦"}]};function Xr(n){return x(`cat.${n}`)||n}const dI={income:["#22c55e","#16a34a","#86efac","#4ade80","#bbf7d0"],expense:["#f43f5e","#e11d48","#fb7185","#f97316","#fb923c","#fbbf24","#a855f7","#8b5cf6","#6366f1"]},fI=new Map([...hn.income,...hn.expense].map(n=>[n.id,n]));function mI(n){const e=fI.get(n);return e?{...e,label:Xr(n)}:{label:n,emoji:"📌"}}const wu="pkey_test_YOUR_OMISE_PUBLIC_KEY",ei=5,wr=["nunmongss@gmail.com"];let Ar=localStorage.getItem("mf_dev_plan")||"pro",ie=JSON.parse(localStorage.getItem("mf_cache_tx")||"[]"),Pi="income",Ls=null,br=null,yr="dashboard",ut=parseInt(localStorage.getItem("mf_cutoff_day"))||1,uf="cycle",hf="",df=null,ff=null,ti=null,it=null,jt={},he={enabled:!0,notifyNear:!0,notifyOver:!0,nearThreshold:80,notifyMode:"always"},Ts={},qe=[],po=new Set,Dn=null,ni=null,Sr=null,De=null,ws=null,pe=null,ne="free",ja=0,qa="",ht=null;const Zr=()=>zd(Si,"users",pe.uid,"transactions"),Ha=()=>zt(Si,"users",pe.uid),Or=()=>zd(Si,"users",pe.uid,"recurring"),gI=ie.length>0;gI&&(mf(),dt("syncing"),mn());Rp($a,n=>{if(n)pe=n,mf(),_I(),za(),dt("syncing"),ie.length>0&&mn(),II(),EI();else{pe=null,ht&&(ht(),ht=null),Dn&&(Dn(),Dn=null),ie=[],qe=[],jt={},ne="free";const e=document.getElementById("btn-dev-toggle");e&&(e.style.display="none"),pI()}});function pI(){document.getElementById("login-screen").style.display="flex",document.getElementById("app-wrapper").style.display="none",dn()}function mf(){document.getElementById("login-screen").style.display="none",document.getElementById("app-wrapper").style.display=""}async function yI(){try{ri(x("loading.signingIn")),await Kp($a,cI)}catch(n){dn(),H(x("toast.signInError")+n.message,"error")}}async function Au(){ht&&(ht(),ht=null),await Pp($a),localStorage.removeItem("mf_cache_tx")}function _I(){if(!pe)return;const n=document.getElementById("user-avatar"),e=document.getElementById("user-name");n&&(n.src=pe.photoURL||""),e&&(e.textContent=pe.displayName||pe.email||"");const t=document.getElementById("mobile-avatar"),r=document.getElementById("mobile-user-name");t&&(t.src=pe.photoURL||""),r&&(r.textContent=pe.displayName||pe.email||"")}function EI(){ht&&ht();const n=tI(Zr(),nI("date","desc"));dt("syncing"),ht=vu(n,e=>{ie=e.docs.map(t=>({id:t.id,...t.data()})),vI(),bI(),mn(),dt("online"),dn()},e=>{console.error("[Firestore] snapshot error:",e),dt("offline"),dn(),H("⚠️ Firestore error: "+e.message,"error",8e3)}),Dn&&Dn(),Dn=vu(Or(),e=>{qe=e.docs.map(t=>({id:t.id,...t.data()})),vf(),zI()})}function vI(){const n=new Date;n.setDate(n.getDate()-90),ie.forEach(e=>{e.imageData&&new Date(e.createdAt)<n&&(e.imageData="",gf(e.id,{imageData:""}).catch(()=>{}))})}async function II(){try{const n=await sf(Ha());if(n.exists()){const e=n.data();e.cutoff_day&&(ut=parseInt(e.cutoff_day)||1,localStorage.setItem("mf_cutoff_day",ut)),ja=e.scan_count||0,qa=e.scan_date||"",ne=wr.includes(pe?.email)?Ar:e.plan||"free",jt=e.budgets||{},he=Object.assign({enabled:!0,notifyNear:!0,notifyOver:!0,nearThreshold:80,notifyMode:"always"},e.budgetSettings||{}),De=e.savingsGoal||null}else wr.includes(pe?.email)&&(ne=Ar);Ci(),BI(),wr.includes(pe?.email)&&za()}catch(n){console.error("loadUserMeta error:",n)}}async function rn(n){await iI(Ha(),n,{merge:!0})}function Ci(){const n=document.getElementById("plan-badge");n&&(n.textContent=ne==="pro"?"⭐ Pro":"Free",n.className="plan-badge "+ne);const e=document.getElementById("mobile-plan-badge");e&&(e.textContent=ne==="pro"?"⭐ Pro":"Free",e.className="plan-badge mobile-plan-badge "+ne);const t=document.getElementById("mobile-btn-updates");t&&(t.style.display=ne==="pro"?"none":"");const r=document.getElementById("btn-upgrade");r&&(r.style.display=ne==="pro"?"none":"");const s=document.getElementById("scan-info");if(s)if(ne==="pro")s.textContent=x("scan.pro"),s.className="scan-info-row pro";else{const a=new Date().toLocaleDateString("sv"),u=ei-(qa===a?ja:0);s.textContent=u>0?x("scan.free.left",{left:u,total:ei}):x("scan.free.exhausted");const d=u<=0?"exhausted":u===1?"danger":u<=3?"warning":"";s.className=`scan-info-row${d?" "+d:""}`}const i=document.getElementById("btn-export-pdf");i&&(i.style.display=ne==="pro"?"":"none")}async function TI(n){dt("syncing"),await af(Zr(),n)}async function gf(n,e){dt("syncing"),await Ua(zt(Zr(),n),e)}async function wI(n){dt("syncing"),await of(zt(Zr(),n))}async function AI(){if(ne==="pro")return!0;const n=new Date().toLocaleDateString("sv"),e=await sf(Ha()),t=e.exists()?e.data():{},s=t.scan_date===n&&t.scan_count||0;if(s>=ei)return si(x("scan.limit.upgrade",{total:ei})),!1;const i=s+1;return await rn({scan_count:i,scan_date:n}),ja=i,qa=n,Ci(),!0}function ri(n){n===void 0&&(n=x("loading.default")),document.getElementById("loading-text").textContent=n,document.getElementById("loading-overlay").classList.add("active")}function dn(){document.getElementById("loading-overlay").classList.remove("active")}function dt(n){const e=document.getElementById("sync-badge"),t=document.getElementById("sync-label");e.className="sync-badge "+n,t.textContent=x(`sync.${n}`)||n}function bI(){localStorage.setItem("mf_cache_tx",JSON.stringify(ie))}function se(n){return"฿"+Number(n).toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}function pf(n){const e=new Date(n);if(isNaN(e.getTime()))return n;const t=un();return e.toLocaleDateString(t,{year:"numeric",month:"short",day:"numeric"})+" · "+e.toLocaleTimeString(t,{hour:"2-digit",minute:"2-digit"})}function We(n,e){return mI(e)}function fn(n){const e=document.createElement("div");return e.appendChild(document.createTextNode(n)),e.innerHTML}function bu(n,e,t){const r=new Date(n,e+1,0).getDate();return new Date(n,e,Math.min(t,r))}function Kn(){const n=new Date,e=n.getFullYear(),t=n.getMonth();let r=bu(e,t,ut);if(n.getDate()<ut){const i=t===0?11:t-1,a=t===0?e-1:e;r=bu(a,i,ut)}const s=new Date(r);return s.setMonth(s.getMonth()+1),{start:r,end:s}}function es(n){if(!n)return!1;const e=new Date(n);if(isNaN(e.getTime()))return!1;const{start:t,end:r}=Kn();return e>=t&&e<r}function SI(){let n=0,e=0;const{start:t,end:r}=Kn();ie.forEach(i=>{if(!i.date)return;const a=new Date(i.date);isNaN(a.getTime())||a<t||a>=r||(i.type==="income"?n+=Number(i.amount):e+=Number(i.amount))});const s=i=>Math.round(i*100)/100;return{income:s(n),expense:s(e),balance:s(n-e)}}let Su;function H(n,e="success",t=3500){const r=document.getElementById("toast");r.textContent=n,r.className=`toast show ${e}`,clearTimeout(Su),Su=setTimeout(()=>{r.className="toast"},t)}function Ru(n){yr=n,document.querySelectorAll(".view").forEach(r=>r.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(r=>r.classList.remove("active")),document.querySelectorAll(".bottom-nav-item").forEach(r=>r.classList.remove("active"));const e=document.getElementById(`view-${n}`);e&&e.classList.add("active");const t=document.getElementById(`nav-${n}`);t&&t.classList.add("active"),document.querySelectorAll(`.bottom-nav-item[data-view="${n}"]`).forEach(r=>r.classList.add("active")),document.getElementById("page-title").textContent=x(`page.${n}`)||n,mn(),window.innerWidth<=900&&document.getElementById("sidebar").classList.remove("open")}function zo(n){const e=document.getElementById("input-category");e.innerHTML="",hn[n].forEach(t=>{const r=document.createElement("option");r.value=t.id,r.textContent=`${t.emoji} ${Xr(t.id)}`,e.appendChild(r)})}function Pu(){const n=document.getElementById("filter-category");n.innerHTML=`<option value="all">${x("tx.filterAllCats")}</option>`,[...hn.income,...hn.expense].forEach(e=>{const t=document.createElement("option");t.value=e.id,t.textContent=`${e.emoji} ${Xr(e.id)}`,n.appendChild(t)})}function RI(){const{income:n,expense:e,balance:t}=SI();document.getElementById("total-balance").textContent=se(t),document.getElementById("total-income").textContent=se(n),document.getElementById("total-expense").textContent=se(e);const r=n>0?Math.min(e/n*100,100):e>0?100:0,s=Math.max(0,Math.round(100-r)),i=document.getElementById("chibi-frame");i?.contentWindow&&i.contentWindow.postMessage({type:"setHp",hp:s},"*");const a=document.getElementById("balance-trend");t>0?a.textContent=x("dash.balance.positive"):t<0?a.textContent=x("dash.balance.negative"):a.textContent=x("dash.balance.zero");const l=window.innerWidth<=900,u=[...ie].sort((d,f)=>new Date(f.date)-new Date(d.date)).slice(0,l?3:5);PI("recent-list",u,"empty-recent"),Go()}function PI(n,e,t){const r=document.getElementById(n);if(r.innerHTML="",e.length===0){const s=document.getElementById(t);s&&r.appendChild(s.cloneNode(!0));return}e.forEach(s=>{const i=We(s.type,s.category),a=!!s.imageData,l=document.createElement("div");l.className="transaction-item",l.innerHTML=`
      ...
      <div class="tx-info">
        ...
        <div class="tx-meta">${i.label} · ${pf(s.date)}</div>
      </div>
      ...
      </div>`,r.appendChild(l)}),r.querySelectorAll(".tx-btn-edit").forEach(s=>s.addEventListener("click",()=>wf(s.dataset.id))),r.querySelectorAll(".tx-btn-delete").forEach(s=>s.addEventListener("click",()=>Af(s.dataset.id))),r.querySelectorAll(".tx-image-btn").forEach(s=>s.addEventListener("click",()=>yf(s.dataset.id)))}function yf(n){const e=ie.find(r=>r.id===n);if(!e?.imageData)return;const t=document.getElementById("slip-lightbox");document.getElementById("slip-lightbox-img").src=e.imageData,t.classList.add("active")}function CI(n){Nn()}function Cu(n){uf=n,document.getElementById("btn-range-all").classList.toggle("active",n==="all"),document.getElementById("btn-range-cycle").classList.toggle("active",n==="cycle"),Nn()}function kI(n){return uf!=="cycle"?n:n.filter(e=>es(e.date))}function DI(n){const e=hf.trim().toLowerCase();return e?n.filter(t=>{const r=We(t.type,t.category);return(t.description||"").toLowerCase().includes(e)||String(t.amount).includes(e)||(r.label||"").toLowerCase().includes(e)}):n}function Nn(){const n=document.getElementById("filter-type").value,e=document.getElementById("filter-category").value;let t=kI([...ie]).sort((r,s)=>new Date(s.date)-new Date(r.date));n!=="all"&&(t=t.filter(r=>r.type===n)),e!=="all"&&(t=t.filter(r=>r.category===e)),t=DI(t),NI("all-list",t,"empty-all")}function NI(n,e,t){const r=document.getElementById(n);if(!r)return;if(r.innerHTML="",e.length===0){const i=document.getElementById(t);i?r.appendChild(i.cloneNode(!0)):r.innerHTML=`<div class="empty-state"><div class="empty-icon">📋</div><p>${x("tx.noItems")}</p></div>`;return}let s=null;e.forEach(i=>{const a=i.date?i.date.slice(0,10):"";if(a!==s){s=a;const g=document.createElement("div");g.className="timeline-date-header";const T=new Date(a+"T00:00:00");g.textContent=isNaN(T)?a:T.toLocaleDateString(un(),{weekday:"short",year:"numeric",month:"short",day:"numeric"}),r.appendChild(g)}const l=We(i.type,i.category),u=document.createElement("div");u.className="transaction-item";const d=!!i.imageData,f=ne==="pro"&&d;u.innerHTML=`
      ...
      <div class="tx-info">
        ...
        <div class="tx-meta">${l.label} · ${pf(i.date)}</div>
    ...
    <div class="pdf-card"><div class="pdf-card-label">คงเหลือ</div><div class="pdf-card-val">${se(s-i)}</div></div>`;const a={};r.filter(f=>f.type==="expense").forEach(f=>{a[f.category]=(a[f.category]||0)+Number(f.amount)}),document.getElementById("pdf-categories").innerHTML=Object.entries(a).sort((f,g)=>g[1]-f[1]).map(([f,g])=>{const T=We("expense",f);return`<div class="pdf-cat-row"><span>${T.emoji} ${T.label}</span><span>${se(g)}</span></div>`}).join("")||"<p>ไม่มีรายจ่าย</p>";const u=[...r].sort((f,g)=>new Date(g.date)-new Date(f.date)).map(f=>{const g=We(f.type,f.category),T=new Date(f.date);return`<tr>
    ...
    </tr>`}).join("");document.getElementById("pdf-transactions").innerHTML=`<thead><tr><th>วันที่</th><th>หมวดหมู่</th><th>รายละเอียด</th><th>จำนวนเงิน</th></tr></thead><tbody>${u}</tbody>`;const d=document.getElementById("pdf-report");d.style.display="block",J("settings-modal-overlay"),setTimeout(()=>{window.print(),setTimeout(()=>{d.style.display="none"},500)},300)}function MI(){const n=document.getElementById("budget-form-rows");n.innerHTML="",hn.expense.forEach(e=>{const t=Xr(e.id),r=jt[e.id]||"",s=document.createElement("div");s.className="budget-row",s.innerHTML=`
      ...
      <input type="number" min="0" step="1" placeholder="ไม่จำกัด"
             data-cat="${e.id}" value="${r}" />`,n.appendChild(s)}),tt("budget-modal-overlay")}async function FI(){const n=document.querySelectorAll("#budget-form-rows input[data-cat]"),e={};n.forEach(t=>{const r=parseFloat(t.value);t.value.trim()!==""&&!isNaN(r)&&r>0&&(e[t.dataset.cat]=r)}),jt=e;try{await rn({budgets:e}),H("💰 บันทึก Budget สำเร็จ","success"),J("budget-modal-overlay"),mn()}catch(t){H("❌ "+t.message,"error")}}function Du(n){if(!he.enabled)return;const e=jt[n];if(!e)return;const{start:t}=Kn(),r=t.toISOString().slice(0,10),s=ie.filter(u=>u.type==="expense"&&u.category===n&&es(u.date)).reduce((u,d)=>u+Number(d.amount),0),i=We("expense",n),a=`${n}_${r}_near`,l=`${n}_${r}_over`;if(s>=e&&he.notifyOver){if(he.notifyMode==="once"&&Ts[l])return;Ts[l]=!0,H(`⚠️ ${i.emoji}${i.label} เกิน Budget แล้ว! (${se(s)} / ${se(e)})`,"error",5e3)}else if(s>=e*(he.nearThreshold/100)&&he.notifyNear){if(he.notifyMode==="once"&&Ts[a])return;Ts[a]=!0,H(`🔔 ${i.emoji}${i.label} ใกล้เกิน Budget (${se(s)} / ${se(e)})`,"warning",4e3)}}function BI(){const n=document.getElementById("toggle-budget-notify"),e=document.getElementById("budget-notify-sub"),t=document.getElementById("toggle-notify-near"),r=document.getElementById("toggle-notify-over"),s=document.getElementById("notify-mode-once"),i=document.getElementById("notify-mode-always");n&&(n.checked=!!he.enabled,e&&(e.style.display=he.enabled?"":"none"),t&&(t.checked=!!he.notifyNear),r&&(r.checked=!!he.notifyOver),s&&(s.checked=he.notifyMode==="once"),i&&(i.checked=he.notifyMode!=="once"))}async function dr(){try{await rn({budgetSettings:he})}catch(n){console.error("saveBudgetSettings error:",n)}}function UI(){const n=new Date,e=ne==="pro"?365:30,t=n.getTime()-e*864e5,r=ie.filter(g=>g.date?new Date(g.date).getTime()>=t:!1).sort((g,T)=>new Date(g.date)-new Date(T.date)),s="\uFEFF",i="วันที่,ประเภท,หมวดหมู่,รายละเอียด,จำนวนเงิน",a=r.map(g=>{const T=We(g.type,g.category),R=g.type==="income"?"รายรับ":"รายจ่าย",k=new Date(g.date).toLocaleDateString("th-TH",{year:"numeric",month:"short",day:"numeric"}),N=`"${(g.description||"").replace(/"/g,'""')}"`;return[k,R,T.label,N,g.amount].join(",")}),l=s+[i,...a].join(`\r
`),u=new Blob([l],{type:"text/csv;charset=utf-8;"}),d=URL.createObjectURL(u),f=document.createElement("a");f.href=d,f.download="moneyflow_export.csv",document.body.appendChild(f),f.click(),document.body.removeChild(f),URL.revokeObjectURL(d),H(`📥 Export สำเร็จ (${r.length} รายการ)`,"success")}function Ef(){const n=document.getElementById("recurring-category");n&&(n.innerHTML="",hn.expense.forEach(e=>{const t=document.createElement("option");t.value=e.id,t.textContent=`${e.emoji} ${Xr(e.id)}`,n.appendChild(t)}))}function $I(){ni=null,document.getElementById("recurring-modal-title").textContent="🔄 เพิ่มรายการประจำ",document.getElementById("recurring-form").reset(),document.getElementById("recurring-edit-id").value="",Ef(),tt("recurring-modal-overlay")}function jI(n){ni=n.id,document.getElementById("recurring-modal-title").textContent="✏️ แก้ไขรายการประจำ",document.getElementById("recurring-edit-id").value=n.id,document.getElementById("recurring-desc").value=n.description||"",document.getElementById("recurring-amount").value=n.amount||"",document.getElementById("recurring-day").value=n.dayOfMonth||"",document.getElementById("recurring-installments").value=n.installments||"",document.getElementById("recurring-note").value=n.note||"",Ef(),setTimeout(()=>{document.getElementById("recurring-category").value=n.category},0),tt("recurring-modal-overlay")}async function qI(n){n.preventDefault();const e=document.getElementById("recurring-desc").value.trim(),t=parseFloat(document.getElementById("recurring-amount").value),r=document.getElementById("recurring-category").value,s=parseInt(document.getElementById("recurring-day").value),i=document.getElementById("recurring-installments").value.trim(),a=i?parseInt(i):null,l=document.getElementById("recurring-note").value.trim();if(!e||!t||!r||!s){H("กรุณากรอกข้อมูลให้ครบ","error");return}const u={description:e,amount:t,category:r,type:"expense",dayOfMonth:s,installments:a,note:l,active:!0,paidCount:0,lastPaidDate:"",createdAt:new Date().toISOString()};try{if(ni){const{createdAt:d,paidCount:f,lastPaidDate:g,...T}=u;await Ua(zt(Or(),ni),T),H("✅ แก้ไขรายการประจำสำเร็จ","success")}else await af(Or(),u),H("✅ เพิ่มรายการประจำสำเร็จ","success");J("recurring-modal-overlay")}catch(d){H("❌ "+d.message,"error")}}async function HI(n){if(confirm("ลบรายการประจำนี้?"))try{await of(zt(Or(),n)),H("🗑️ ลบรายการประจำสำเร็จ","success")}catch(e){H("❌ "+e.message,"error")}}function xs(n){const e=new Date,t=e.getDate(),r=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`,s=n.installments&&(n.paidCount||0)>=n.installments,i=n.lastPaidDate&&n.lastPaidDate.startsWith(r),a=!n.paidCount&&!n.lastPaidDate;if(s)return{key:"done",label:"✅ ครบทุกงวดแล้ว",canPay:!1};if(i)return{key:"paid",label:"✅ จ่ายแล้วเดือนนี้",canPay:!1};const l=n.dayOfMonth-t;if(a&&l<0){const u=new Date(e.getFullYear(),e.getMonth()+1,n.dayOfMonth),d=Math.ceil((u-e)/864e5),f=String(e.getMonth()+2).padStart(2,"0");return{key:"pending",label:`⏳ ครั้งแรก วันที่ ${n.dayOfMonth}/${f} (อีก ${d} วัน)`,canPay:!1}}return l<0?{key:"overdue",label:"🔴 เลยกำหนดแล้ว ยังไม่ได้จ่าย",canPay:!0}:l===0?{key:"overdue",label:"🔴 ถึงกำหนดวันนี้!",canPay:!0}:l<=3?{key:"soon",label:`🟡 อีก ${l} วัน`,canPay:!0}:{key:"pending",label:`⏳ อีก ${l} วัน`,canPay:!1}}function vf(){const n=document.getElementById("recurring-list");if(!n)return;if(qe.length===0){n.innerHTML='<div class="empty-state"><div class="empty-icon">🔄</div><p>ยังไม่มีรายการประจำ<br><small style="color:var(--text-3)">กด "+ เพิ่มรายการประจำ" เพื่อเริ่ม</small></p></div>';return}n.innerHTML="";const e={overdue:0,soon:1,pending:2,paid:3,done:4};[...qe].sort((r,s)=>{const i=xs(r).key,a=xs(s).key;return(e[i]??5)-(e[a]??5)}).forEach(r=>{const s=We("expense",r.category),i=xs(r),a=r.installments?r.installments-(r.paidCount||0):null,l=a!==null?`${a} งวดคงเหลือ`:"∞",u=document.createElement("div");u.className=`recurring-item${i.key==="overdue"?" rec-overdue":i.key==="soon"?" rec-soon":""}`,u.innerHTML=`
      ...
      </div>`,n.appendChild(u),u.querySelectorAll(".btn-add-from-recurring").forEach(d=>d.addEventListener("click",()=>{const f=qe.find(g=>g.id===d.dataset.id);f&&(Wo(),setTimeout(()=>If(f),60))})),u.querySelectorAll(".tx-btn-edit").forEach(d=>d.addEventListener("click",()=>{const f=qe.find(g=>g.id===d.dataset.id);f&&jI(f)})),u.querySelectorAll(".tx-btn-delete").forEach(d=>d.addEventListener("click",()=>HI(d.dataset.id)))})}function If(n){Sr=n.id,Un("expense"),setTimeout(()=>{document.getElementById("input-amount").value=n.amount,document.getElementById("input-description").value=n.description,setTimeout(()=>{document.getElementById("input-category").value=n.category},30)},30),document.querySelectorAll(".recurring-chip").forEach(t=>t.classList.remove("selected"));const e=document.querySelector(`.recurring-chip[data-id="${n.id}"]`);e&&e.classList.add("selected")}function zI(){const n=new Date,e=n.getDate(),t=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`;qe.forEach(r=>{!r.active||r.installments&&(r.paidCount||0)>=r.installments||r.lastPaidDate&&r.lastPaidDate.startsWith(t)||r.dayOfMonth<=e&&!po.has(r.id)&&(po.add(r.id),setTimeout(()=>{H(`🔔 ${r.description} ครบกำหนดชำระวันนี้!`,"warning",5e3)},1e3+po.size*1500))})}function Wo(){br=null,Sr=null,document.getElementById("modal-title").textContent=x("modal.addTitle"),document.getElementById("submit-label").textContent=x("modal.addBtn"),document.getElementById("transaction-form").reset(),document.getElementById("edit-id").value="";const n=new Date;document.getElementById("input-date").value=new Date(n-n.getTimezoneOffset()*6e4).toISOString().slice(0,16),ki(),Un("income"),GI(),tt("modal-overlay")}function Tf(n){const e=document.getElementById("recurring-shortcuts-wrap");if(!e)return;if(n!=="expense"||!qe.length){e.innerHTML="",e.style.display="none";return}const t=[],r=[];if(qe.forEach(a=>{if(!a.active)return;const l=xs(a);l.key==="done"||l.key==="paid"||(l.key==="overdue"||l.key==="soon"?t.push({item:a,s:l}):r.push({item:a,s:l}))}),!t.length&&!r.length){e.innerHTML="",e.style.display="none";return}const s=({item:a,s:l})=>{const u=We("expense",a.category);return`<button class="recurring-chip ${l.key}" data-id="${a.id}">
    ...
    </div>`}e.innerHTML=i,e.style.display="",e.querySelectorAll(".recurring-chip").forEach(a=>{a.addEventListener("click",()=>{const l=qe.find(u=>u.id===a.dataset.id);l&&If(l)})})}function GI(){Tf(Pi)}function wf(n){const e=ie.find(t=>t.id===n);e&&(br=n,document.getElementById("modal-title").textContent=x("modal.editTitle"),document.getElementById("submit-label").textContent=x("modal.editBtn"),document.getElementById("edit-id").value=n,document.getElementById("input-amount").value=e.amount,document.getElementById("input-description").value=e.description,document.getElementById("input-date").value=e.date,ki(),Un(e.type),setTimeout(()=>{document.getElementById("input-category").value=e.category},0),tt("modal-overlay"))}function Un(n){Pi=n,document.getElementById("type-income").classList.toggle("active",n==="income"),document.getElementById("type-expense").classList.toggle("active",n==="expense"),zo(n),Tf(n)}function tt(n){document.getElementById(n).classList.add("open")}function J(n){document.getElementById(n).classList.remove("open")}function Af(n){Ls=n,tt("delete-overlay")}function si(n=""){document.getElementById("upgrade-reason").textContent=n,tt("upgrade-modal-overlay")}async function WI(n){n.preventDefault();const e=parseFloat(document.getElementById("input-amount").value),t=document.getElementById("input-description").value.trim(),r=document.getElementById("input-category").value,s=document.getElementById("input-date").value;if(!e||e<=0||!t||!r||!s){H(x("toast.fieldRequired"),"error");return}const i=!!br,a=document.getElementById("check-continue").checked,l=document.getElementById("btn-submit");l.disabled=!0;try{const u={type:Pi,amount:e,description:t,category:r,date:s,createdAt:new Date().toISOString(),imageData:ne==="pro"&&ti?ti:""};if(i)await gf(br,u),br=null,H(x("toast.editSaved")),J("modal-overlay"),u.type==="expense"&&setTimeout(()=>Du(u.category),500);else{if(await TI(u),Sr){const d=qe.find(f=>f.id===Sr);if(d){const f=new Date().toLocaleDateString("sv");Ua(zt(Or(),d.id),{paidCount:(d.paidCount||0)+1,lastPaidDate:f}).catch(()=>{})}Sr=null}if(H(x("toast.saved")),u.type==="expense"&&setTimeout(()=>Du(u.category),500),a){document.getElementById("input-amount").value="",document.getElementById("input-description").value="",ki();const d=new Date;document.getElementById("input-date").value=new Date(d-d.getTimezoneOffset()*6e4).toISOString().slice(0,16),document.getElementById("input-amount").focus()}else J("modal-overlay")}}catch(u){H("❌ "+u.message,"error")}finally{l.disabled=!1}}function ki(){df=null,ff=null,ti=null;const n=document.getElementById("image-preview-container"),e=document.getElementById("image-preview");e.src="",n.style.display="none",document.getElementById("input-slip").value=""}function KI(n,e,t=800,r=.72){return new Promise(s=>{const i=new Image;i.onload=()=>{let{width:a,height:l}=i;(a>t||l>t)&&(a>l?(l=Math.round(l*t/a),a=t):(a=Math.round(a*t/l),l=t));const u=document.createElement("canvas");u.width=a,u.height=l,u.getContext("2d").drawImage(i,0,0,a,l),s(u.toDataURL("image/jpeg",r))},i.onerror=()=>s(`data:${e};base64,${n}`),i.src=`data:${e};base64,${n}`})}async function QI(n){const e=n.target.files[0];if(!e)return;const t=document.getElementById("scan-progress"),r=t.querySelector(".progress-bar"),s=t.querySelector(".progress-text");t.classList.add("active"),s.textContent=x("modal.prepareImg"),r.style.setProperty("--progress","10%");try{if(!await AI()){t.classList.remove("active"),document.getElementById("input-slip").value="";return}const a=await JI(e),l=e.type||"image/jpeg";df=a,ff=l,ti=ne==="pro"?await KI(a,l,1200,.82):null;const u=document.getElementById("image-preview-container"),d=document.getElementById("image-preview");d.src=`data:${l};base64,${a}`,u.style.display="block",s.textContent=x("modal.analyzing"),r.style.setProperty("--progress","40%");const f=await fetch("/api/scan",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({base64Data:a,mimeType:l})});if(!f.ok){const T=await f.json().catch(()=>({}));throw new Error(T.error||`Server Error ${f.status}`)}const g=await f.json();r.style.setProperty("--progress","90%"),g.amount?(document.getElementById("input-amount").value=g.amount,g.description&&(document.getElementById("input-description").value=g.description),H(x("toast.scanSuccess"))):H(x("toast.scanNoAmount"),"error"),Un("expense"),r.style.setProperty("--progress","100%")}catch(i){console.error("Scan error:",i),H(x("toast.scanError",{msg:i.message}),"error",6e3)}finally{document.getElementById("input-slip").value="",setTimeout(()=>t.classList.remove("active"),500)}}function JI(n){return new Promise((e,t)=>{const r=new FileReader;r.readAsDataURL(n),r.onload=()=>e(r.result.split(",")[1]),r.onerror=t})}function za(){const n=document.getElementById("btn-dev-toggle");if(!n)return;const e=wr.includes(pe?.email);n.style.display=e?"":"none",n.textContent=x(ne==="pro"?"dev.switchFree":"dev.switchPro")}function YI(){wr.includes(pe?.email)&&(Ar=ne==="pro"?"free":"pro",localStorage.setItem("mf_dev_plan",Ar),ne=Ar,Ci(),za(),H(x("dev.toasted")+(ne==="pro"?"Pro ⭐":"Free")))}async function XI(){if(wu.includes("YOUR_OMISE")){H(x("toast.paymentSoon"),"error",4e3);return}window.OmiseCard||await new Promise((n,e)=>{const t=document.createElement("script");t.src="https://cdn.omise.co/omise.js",t.onload=n,t.onerror=e,document.head.appendChild(t)}),window.OmiseCard.configure({publicKey:wu}),window.OmiseCard.open({frameLabel:"MoneyFlow Pro",submitLabel:x("upgrade.pay"),currency:"THB",amount:7900,onCreateTokenSuccess:async n=>{try{ri(x("loading.payment")),J("upgrade-modal-overlay");const t=await(await fetch("/api/payment-create",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,uid:pe.uid,email:pe.email})})).json();t.success?(ne="pro",await rn({plan:"pro",pro_until:t.pro_until}),Ci(),H(x("toast.paymentSuccess"),"success",5e3)):H(x("toast.paymentFail")+(t.error||""),"error")}catch(e){H("❌ "+e.message,"error")}finally{dn()}},onFormClosed:()=>{}})}function Nu(){const n=document.getElementById("changelog-body"),e={new:"✨",fix:"🐛",improve:"⚡"},t=un();n.innerHTML=uI.map(r=>`
    ...
    </div>`).join(""),document.getElementById("changelog-overlay").classList.add("open"),J("settings-modal-overlay")}function ZI(){Tu(),zo("income"),Pu();const n=document.getElementById("app-version");n&&(n.textContent="v"+lI),document.getElementById("btn-google-signin").addEventListener("click",yI),document.querySelectorAll(".nav-item, .bottom-nav-item").forEach(i=>i.addEventListener("click",()=>{Ru(i.dataset.view),document.getElementById("sidebar").classList.remove("open")})),document.getElementById("see-all-btn").addEventListener("click",()=>Ru("transactions")),document.getElementById("menu-toggle").addEventListener("click",()=>document.getElementById("sidebar").classList.toggle("open")),document.addEventListener("click",i=>{const a=document.getElementById("sidebar"),l=document.getElementById("menu-toggle");window.innerWidth<=900&&a.classList.contains("open")&&!a.contains(i.target)&&i.target!==l&&a.classList.remove("open")}),document.getElementById("btn-open-modal").addEventListener("click",Wo),document.getElementById("mobile-fab")?.addEventListener("click",Wo),document.getElementById("type-income").addEventListener("click",()=>Un("income")),document.getElementById("type-expense").addEventListener("click",()=>Un("expense")),document.getElementById("modal-close").addEventListener("click",()=>J("modal-overlay")),document.getElementById("modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&J("modal-overlay")}),document.getElementById("transaction-form").addEventListener("submit",WI),document.getElementById("delete-confirm").addEventListener("click",async()=>{if(!Ls)return;const i=Ls;Ls=null,J("delete-overlay");try{ri(x("loading.deleting")),await wI(i),H(x("toast.deleted"))}catch(a){H(x("toast.deleteError")+a.message,"error")}finally{dn()}}),document.getElementById("delete-cancel").addEventListener("click",()=>J("delete-overlay")),document.getElementById("delete-cancel-x").addEventListener("click",()=>J("delete-overlay")),document.getElementById("delete-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&J("delete-overlay")}),document.getElementById("btn-clear-all").addEventListener("click",async()=>{if(ie.length===0){H(x("toast.clearNone"),"error");return}if(confirm(x("confirm.clearAll"))){J("settings-modal-overlay");try{ri(x("loading.clearing"));const i=oI(Si);ie.forEach(a=>i.delete(zt(Zr(),a.id))),await i.commit(),H(x("toast.clearAll"))}catch(i){H("❌ "+i.message,"error")}finally{dn()}}}),document.getElementById("filter-type").addEventListener("change",Nn),document.getElementById("filter-category").addEventListener("change",Nn),document.getElementById("tx-search").addEventListener("input",i=>{hf=i.target.value,Nn()}),document.getElementById("btn-remove-image").addEventListener("click",ki),document.getElementById("btn-open-settings").addEventListener("click",()=>{document.getElementById("input-cutoff-day").value=ut,document.getElementById("select-language").value=go(),tt("settings-modal-overlay")}),document.getElementById("settings-modal-close").addEventListener("click",()=>J("settings-modal-overlay")),document.getElementById("settings-modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&J("settings-modal-overlay")}),document.getElementById("btn-save-settings").addEventListener("click",async()=>{const i=parseInt(document.getElementById("input-cutoff-day").value),a=document.getElementById("select-language").value;if(i<1||i>31||isNaN(i)){H(x("toast.cutoffError"),"error");return}a!==go()&&(hI(a),Tu(),zo(Pi),Pu(),dt(document.getElementById("sync-badge").className.replace("sync-badge ","").trim()||"offline")),ut=i,localStorage.setItem("mf_cutoff_day",ut);try{await rn({cutoff_day:i}),H(x("toast.settingsSaved"))}catch{H(x("toast.settingsLocal"),"error")}J("settings-modal-overlay"),mn()}),document.getElementById("btn-upgrade").addEventListener("click",()=>si()),document.getElementById("btn-trends-upgrade")?.addEventListener("click",()=>si(x("trends.upgradeBtn"))),document.getElementById("upgrade-modal-close").addEventListener("click",()=>J("upgrade-modal-overlay")),document.getElementById("upgrade-modal-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&J("upgrade-modal-overlay")}),document.getElementById("btn-pay-omise").addEventListener("click",XI),document.getElementById("btn-view-list")?.addEventListener("click",()=>CI()),document.getElementById("btn-range-all")?.addEventListener("click",()=>Cu("all")),document.getElementById("btn-range-cycle")?.addEventListener("click",()=>Cu("cycle"));const e=document.getElementById("btn-dev-toggle");e&&e.addEventListener("click",YI),document.getElementById("btn-signout").addEventListener("click",Au),document.getElementById("btn-signout-settings")?.addEventListener("click",Au),document.getElementById("mobile-btn-updates")?.addEventListener("click",Nu),document.getElementById("mobile-btn-settings")?.addEventListener("click",()=>{document.getElementById("input-cutoff-day").value=ut,document.getElementById("select-language").value=go(),tt("settings-modal-overlay")}),document.getElementById("btn-changelog").addEventListener("click",Nu),document.getElementById("changelog-close").addEventListener("click",()=>J("changelog-overlay")),document.getElementById("changelog-overlay").addEventListener("click",i=>{i.target===i.currentTarget&&J("changelog-overlay")});const t=()=>document.getElementById("slip-lightbox").classList.remove("active");document.getElementById("slip-lightbox-close").addEventListener("click",t),document.getElementById("slip-lightbox-backdrop").addEventListener("click",t),document.getElementById("btn-scan").addEventListener("click",()=>document.getElementById("input-slip").click()),document.getElementById("input-slip").addEventListener("change",QI),document.getElementById("btn-open-budget")?.addEventListener("click",MI),document.getElementById("budget-modal-close")?.addEventListener("click",()=>J("budget-modal-overlay")),document.getElementById("budget-modal-overlay")?.addEventListener("click",i=>{i.target===i.currentTarget&&J("budget-modal-overlay")}),document.getElementById("btn-save-budget")?.addEventListener("click",FI),document.getElementById("btn-cancel-budget")?.addEventListener("click",()=>J("budget-modal-overlay")),document.getElementById("btn-add-recurring")?.addEventListener("click",$I),document.getElementById("recurring-modal-close")?.addEventListener("click",()=>J("recurring-modal-overlay")),document.getElementById("recurring-modal-overlay")?.addEventListener("click",i=>{i.target===i.currentTarget&&J("recurring-modal-overlay")}),document.getElementById("recurring-form")?.addEventListener("submit",qI),document.getElementById("btn-cancel-recurring")?.addEventListener("click",()=>J("recurring-modal-overlay")),document.getElementById("btn-export-csv")?.addEventListener("click",UI),document.getElementById("btn-export-pdf")?.addEventListener("click",OI),document.getElementById("monthly-range-select")?.addEventListener("change",_f),document.getElementById("btn-edit-savings-goal")?.addEventListener("click",()=>{De?(document.getElementById("savings-goal-name").value=De.name||"",document.getElementById("savings-goal-amount").value=De.targetAmount||"",document.getElementById("savings-goal-deadline").value=De.deadline||""):(document.getElementById("savings-goal-name").value="",document.getElementById("savings-goal-amount").value="",document.getElementById("savings-goal-deadline").value=""),tt("savings-goal-modal-overlay")}),document.getElementById("savings-goal-modal-close")?.addEventListener("click",()=>J("savings-goal-modal-overlay")),document.getElementById("savings-goal-modal-overlay")?.addEventListener("click",i=>{i.target===i.currentTarget&&J("savings-goal-modal-overlay")}),document.getElementById("btn-save-savings-goal")?.addEventListener("click",async()=>{const i=document.getElementById("savings-goal-name").value.trim(),a=parseFloat(document.getElementById("savings-goal-amount").value),l=document.getElementById("savings-goal-deadline").value;if(!a||a<=0){H("กรุณาใส่จำนวนเงินเป้าหมาย","error");return}De={name:i,targetAmount:a,deadline:l},await rn({savingsGoal:De}),J("savings-goal-modal-overlay"),Go(),H("🎯 บันทึกเป้าหมายสำเร็จ")}),document.getElementById("btn-clear-savings-goal")?.addEventListener("click",async()=>{confirm("ลบเป้าหมายการออม?")&&(De=null,await rn({savingsGoal:null}),J("savings-goal-modal-overlay"),Go(),H("ลบเป้าหมายแล้ว","warning"))});const r=document.getElementById("toggle-budget-notify"),s=document.getElementById("budget-notify-sub");r?.addEventListener("change",()=>{he.enabled=r.checked,s&&(s.style.display=he.enabled?"":"none"),dr()}),document.getElementById("toggle-notify-near")?.addEventListener("change",i=>{he.notifyNear=i.target.checked,dr()}),document.getElementById("toggle-notify-over")?.addEventListener("change",i=>{he.notifyOver=i.target.checked,dr()}),document.getElementById("notify-mode-once")?.addEventListener("change",i=>{i.target.checked&&(he.notifyMode="once",dr())}),document.getElementById("notify-mode-always")?.addEventListener("change",i=>{i.target.checked&&(he.notifyMode="always",dr())}),ie.length>0&&mn()}ZI();
