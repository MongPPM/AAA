...
*/var Rt,ah;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,p){function _(){}_.prototype=p.prototype,I.F=p.prototype,I.prototype=new _,I.prototype.constructor=I,I.D=function(v,E,A){for(var y=Array(arguments.length-2),De=2;De<arguments.length;De++)y[De-2]=arguments[De];return p.prototype[E].apply(v,y)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(I,p,_){_||(_=0);const v=Array(16);if(typeof p=="string")for(var E=0;E<16;++E)v[E]=p.charCodeAt(_++)|p.charCodeAt(_++)<<8|p.charCodeAt(_++)<<16|p.charCodeAt(_++)<<24;else for(E=0;E<16;++E)v[E]=p[_++]|p[_++]<<8|p[_++]<<16|p[_++]<<24;p=I.g[0],_=I.g[1],E=I.g[2];let A=I.g[3],y;y=p+(A^_&(E^A))+v[0]+3614090360&4294967295,p=_+(y<<7&4294967295|y>>>25),y=A+(E^p&(_^E))+v[1]+3905402710&4294967295,A=p+(y<<12&4294967295|y>>>20),y=E+(_^A&(p^_))+v[2]+606105819&4294967295,E=A+(y<<17&4294967295|y>>>15),y=_+(p^E&(A^p))+v[3]+3250441966&4294967295,_=E+(y<<22&4294967295|y>>>10),y=p+(A^_&(E^A))+v[4]+4118548399&4294967295,p=_+(y<<7&4294967295|y>>>25),y=A+(E^p&(_^E))+v[5]+1200080426&4294967295,A=p+(y<<12&4294967295|y>>>20),y=E+(_^A&(p^_))+v[6]+2821735955&4294967295,E=A+(y<<17&4294967295|y>>>15),y=_+(p^E&(A^p))+v[7]+4249261313&4294967295,_=E+(y<<22&4294967295|y>>>10),y=p+(A^_&(E^A))+v[8]+1770035416&4294967295,p=_+(y<<7&4294967295|y>>>25),y=A+(E^p&(_^E))+v[9]+2336552879&4294967295,A=p+(y<<12&4294967295|y>>>20),y=E+(_^A&(p^_))+v[10]+4294925233&4294967295,E=A+(y<<17&4294967295|y>>>15),y=_+(p^E&(A^p))+v[11]+2304563134&4294967295,_=E+(y<<22&4294967295|y>>>10),y=p+(A^_&(E^A))+v[12]+1804603682&4294967295,p=_+(y<<7&4294967295|y>>>25),y=A+(E^p&(_^E))+v[13]+4254626195&4294967295,A=p+(y<<12&4294967295|y>>>20),y=E+(_^A&(p^_))+v[14]+2792965006&4294967295,E=A+(y<<17&4294967295|y>>>15),y=_+(p^E&(A^p))+v[15]+1236535329&4294967295,_=E+(y<<22&4294967295|y>>>10),y=p+(E^A&(_^E))+v[1]+4129170786&4294967295,p=_+(y<<5&4294967295|y>>>27),y=A+(_^E&(p^_))+v[6]+3225465664&4294967295,A=p+(y<<9&4294967295|y>>>23),y=E+(p^_&(A^p))+v[11]+643717713&4294967295,E=A+(y<<14&4294967295|y>>>18),y=_+(A^p&(E^A))+v[0]+3921069994&4294967295,_=E+(y<<20&4294967295|y>>>12),y=p+(E^A&(_^E))+v[5]+3593408605&4294967295,p=_+(y<<5&4294967295|y>>>27),y=A+(_^E&(p^_))+v[10]+38016083&4294967295,A=p+(y<<9&4294967295|y>>>23),y=E+(p^_&(A^p))+v[15]+3634488961&4294967295,E=A+(y<<14&4294967295|y>>>18),y=_+(A^p&(E^A))+v[4]+3889429448&4294967295,_=E+(y<<20&4294967295|y>>>12),y=p+(E^A&(_^E))+v[9]+568446438&4294967295,p=_+(y<<5&4294967295|y>>>27),y=A+(_^E&(p^_))+v[14]+3275163606&4294967295,A=p+(y<<9&4294967295|y>>>23),y=E+(p^_&(A^p))+v[3]+4107603335&4294967295,E=A+(y<<14&4294967295|y>>>18),y=_+(A^p&(E^A))+v[8]+1163531501&4294967295,_=E+(y<<20&4294967295|y>>>12),y=p+(E^A&(_^E))+v[13]+2850285829&4294967295,p=_+(y<<5&4294967295|y>>>27),y=A+(_^E&(p^_))+v[2]+4243563512&4294967295,A=p+(y<<9&4294967295|y>>>23),y=E+(p^_&(A^p))+v[7]+1735328473&4294967295,E=A+(y<<14&4294967295|y>>>18),y=_+(A^p&(E^A))+v[12]+2368359562&4294967295,_=E+(y<<20&4294967295|y>>>12),y=p+(_^E^A)+v[5]+4294588738&4294967295,p=_+(y<<4&4294967295|y>>>28),y=A+(p^_^E)+v[8]+2272392833&4294967295,A=p+(y<<11&4294967295|y>>>21),y=E+(A^p^_)+v[11]+1839030562&4294967295,E=A+(y<<16&4294967295|y>>>16),y=_+(E^A^p)+v[14]+4259657740&4294967295,_=E+(y<<23&4294967295|y>>>9),y=p+(_^E^A)+v[1]+2763975236&4294967295,p=_+(y<<4&4294967295|y>>>28),y=A+(p^_^E)+v[4]+1272893353&4294967295,A=p+(y<<11&4294967295|y>>>21),y=E+(A^p^_)+v[7]+4139469664&4294967295,E=A+(y<<16&4294967295|y>>>16),y=_+(E^A^p)+v[10]+3200236656&4294967295,_=E+(y<<23&4294967295|y>>>9),y=p+(_^E^A)+v[13]+681279174&4294967295,p=_+(y<<4&4294967295|y>>>28),y=A+(p^_^E)+v[0]+3936430074&4294967295,A=p+(y<<11&4294967295|y>>>21),y=E+(A^p^_)+v[3]+3572445317&4294967295,E=A+(y<<16&4294967295|y>>>16),y=_+(E^A^p)+v[6]+76029189&4294967295,_=E+(y<<23&4294967295|y>>>9),y=p+(_^E^A)+v[9]+3654602809&4294967295,p=_+(y<<4&4294967295|y>>>28),y=A+(p^_^E)+v[12]+3873151461&4294967295,A=p+(y<<11&4294967295|y>>>21),y=E+(A^p^_)+v[15]+530742520&4294967295,E=A+(y<<16&4294967295|y>>>16),y=_+(E^A^p)+v[2]+3299628645&4294967295,_=E+(y<<23&4294967295|y>>>9),y=p+(E^(_|~A))+v[0]+4096336452&4294967295,p=_+(y<<6&4294967295|y>>>26),y=A+(_^(p|~E))+v[7]+1126891415&4294967295,A=p+(y<<10&4294967295|y>>>22),y=E+(p^(A|~_))+v[14]+2878612391&4294967295,E=A+(y<<15&4294967295|y>>>17),y=_+(A^(E|~p))+v[5]+4237533241&4294967295,_=E+(y<<21&4294967295|y>>>11),y=p+(E^(_|~A))+v[12]+1700485571&4294967295,p=_+(y<<6&4294967295|y>>>26),y=A+(_^(p|~E))+v[3]+2399980690&4294967295,A=p+(y<<10&4294967295|y>>>22),y=E+(p^(A|~_))+v[10]+4293915773&4294967295,E=A+(y<<15&4294967295|y>>>17),y=_+(A^(E|~p))+v[1]+2240044497&4294967295,_=E+(y<<21&4294967295|y>>>11),y=p+(E^(_|~A))+v[8]+1873313359&4294967295,p=_+(y<<6&4294967295|y>>>26),y=A+(_^(p|~E))+v[15]+4264355552&4294967295,A=p+(y<<10&4294967295|y>>>22),y=E+(p^(A|~_))+v[6]+2734768916&4294967295,E=A+(y<<15&4294967295|y>>>17),y=_+(A^(E|~p))+v[13]+1309151649&4294967295,_=E+(y<<21&4294967295|y>>>11),y=p+(E^(_|~A))+v[4]+4149444226&4294967295,p=_+(y<<6&4294967295|y>>>26),y=A+(_^(p|~E))+v[11]+3174756917&4294967295,A=p+(y<<10&4294967295|y>>>22),y=E+(p^(A|~_))+v[2]+718787259&4294967295,E=A+(y<<15&4294967295|y>>>17),y=_+(A^(E|~p))+v[9]+3951481745&4294967295,I.g[0]=I.g[0]+p&4294967295,I.g[1]=I.g[1]+(E+(y<<21&4294967295|y>>>11))&4294967295,I.g[2]=I.g[2]+E&4294967295,I.g[3]=I.g[3]+A&4294967295}r.prototype.v=function(I,p){p===void 0&&(p=I.length);const _=p-this.blockSize,v=this.C;let E=this.h,A=0;for(;A<p;){if(E==0)for(;A<=_;)s(this,I,A),A+=this.blockSize;if(typeof I=="string"){for(;A<p;)if(v[E++]=I.charCodeAt(A++),E==this.blockSize){s(this,v),E=0;break}}else for(;A<p;)if(v[E++]=I[A++],E==this.blockSize){s(this,v),E=0;break}}this.h=E,this.o+=p},r.prototype.A=function(){var I=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);I[0]=128;for(var p=1;p<I.length-8;++p)I[p]=0;p=this.o*8;for(var _=I.length-8;_<I.length;++_)I[_]=p&255,p/=256;for(this.v(I),I=Array(16),p=0,_=0;_<4;++_)for(let v=0;v<32;v+=8)I[p++]=this.g[_]>>>v&255;return I};function o(I,p){var _=l;return Object.prototype.hasOwnProperty.call(_,I)?_[I]:_[I]=p(I)}function a(I,p){this.h=p;const _=[];let v=!0;for(let E=I.length-1;E>=0;E--){const A=I[E]|0;v&&A==p||(_[E]=A,v=!1)}this.g=_}var l={};function h(I){return-128<=I&&I<128?o(I,function(p){return new a([p|0],p<0?-1:0)}):new a([I|0],I<0?-1:0)}function d(I){if(isNaN(I)||!isFinite(I))return g;if(I<0)return C(d(-I));const p=[];let _=1;for(let v=0;I>=_;v++)p[v]=I/_|0,_*=4294967296;return new a(p,0)}function m(I,p){if(I.length==0)throw Error("number format error: empty string");if(p=p||10,p<2||36<p)throw Error("radix out of range: "+p);if(I.charAt(0)=="-")return C(m(I.substring(1),p));if(I.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=d(Math.pow(p,8));let v=g;for(let A=0;A<I.length;A+=8){var E=Math.min(8,I.length-A);const y=parseInt(I.substring(A,A+E),p);E<8?(E=d(Math.pow(p,E)),v=v.j(E).add(d(y))):(v=v.j(_),v=v.add(d(y)))}return v}var g=h(0),w=h(1),R=h(16777216);n=a.prototype,n.m=function(){if(L(this))return-C(this).m();let I=0,p=1;for(let _=0;_<this.g.length;_++){const v=this.i(_);I+=(v>=0?v:4294967296+v)*p,p*=4294967296}return I},n.toString=function(I){if(I=I||10,I<2||36<I)throw Error("radix out of range: "+I);if(V(this))return"0";if(L(this))return"-"+C(this).toString(I);const p=d(Math.pow(I,6));var _=this;let v="";for(;;){const E=Ce(_,p).g;_=j(_,E.j(p));let A=((_.g.length>0?_.g[0]:_.h)>>>0).toString(I);if(_=E,V(_))return A+v;for(;A.length<6;)A="0"+A;v=A+v}},n.i=function(I){return I<0?0:I<this.g.length?this.g[I]:this.h};function V(I){if(I.h!=0)return!1;for(let p=0;p<I.g.length;p++)if(I.g[p]!=0)return!1;return!0}function L(I){return I.h==-1}n.l=function(I){return I=j(this,I),L(I)?-1:V(I)?0:1};function C(I){const p=I.g.length,_=[];for(let v=0;v<p;v++)_[v]=~I.g[v];return new a(_,~I.h).add(w)}n.abs=function(){return L(this)?C(this):this},n.add=function(I){const p=Math.max(this.g.length,I.g.length),_=[];let v=0;for(let E=0;E<=p;E++){let A=v+(this.i(E)&65535)+(I.i(E)&65535),y=(A>>>16)+(this.i(E)>>>16)+(I.i(E)>>>16);v=y>>>16,A&=65535,y&=65535,_[E]=y<<16|A}return new a(_,_[_.length-1]&-2147483648?-1:0)};function j(I,p){return I.add(C(p))}n.j=function(I){if(V(this)||V(I))return g;if(L(this))return L(I)?C(this).j(C(I)):C(C(this).j(I));if(L(I))return C(this.j(C(I)));if(this.l(R)<0&&I.l(R)<0)return d(this.m()*I.m());const p=this.g.length+I.g.length,_=[];for(var v=0;v<2*p;v++)_[v]=0;for(v=0;v<this.g.length;v++)for(let E=0;E<I.g.length;E++){const A=this.i(v)>>>16,y=this.i(v)&65535,De=I.i(E)>>>16,Ut=I.i(E)&65535;_[2*v+2*E]+=y*Ut,W(_,2*v+2*E),_[2*v+2*E+1]+=A*Ut,W(_,2*v+2*E+1),_[2*v+2*E+1]+=y*De,W(_,2*v+2*E+1),_[2*v+2*E+2]+=A*De,W(_,2*v+2*E+2)}for(I=0;I<p;I++)_[I]=_[2*I+1]<<16|_[2*I];for(I=p;I<2*p;I++)_[I]=0;return new a(_,0)};function W(I,p){for(;(I[p]&65535)!=I[p];)I[p+1]+=I[p]>>>16,I[p]&=65535,p++}function ee(I,p){this.g=I,this.h=p}function Ce(I,p){if(V(p))throw Error("division by zero");if(V(I))return new ee(g,g);if(L(I))return p=Ce(C(I),p),new ee(C(p.g),C(p.h));if(L(p))return p=Ce(I,C(p)),new ee(C(p.g),p.h);if(I.g.length>30){if(L(I)||L(p))throw Error("slowDivide_ only works with positive integers.");for(var _=w,v=p;v.l(I)<=0;)_=Me(_),v=Me(v);var E=ye(_,1),A=ye(v,1);for(v=ye(v,2),_=ye(_,2);!V(v);){var y=A.add(v);y.l(I)<=0&&(E=E.add(_),A=y),v=ye(v,1),_=ye(_,1)}return p=j(I,E.j(p)),new ee(E,p)}for(E=g;I.l(p)>=0;){for(_=Math.max(1,Math.floor(I.m()/p.m())),v=Math.ceil(Math.log(_)/Math.LN2),v=v<=48?1:Math.pow(2,v-48),A=d(_),y=A.j(p);L(y)||y.l(I)>0;)_-=v,A=d(_),y=A.j(p);V(A)&&(A=w),E=E.add(A),I=j(I,y)}return new ee(E,I)}n.B=function(I){return Ce(this,I).h},n.and=function(I){const p=Math.max(this.g.length,I.g.length),_=[];for(let v=0;v<p;v++)_[v]=this.i(v)&I.i(v);return new a(_,this.h&I.h)},n.or=function(I){const p=Math.max(this.g.length,I.g.length),_=[];for(let v=0;v<p;v++)_[v]=this.i(v)|I.i(v);return new a(_,this.h|I.h)},n.xor=function(I){const p=Math.max(this.g.length,I.g.length),_=[];for(let v=0;v<p;v++)_[v]=this.i(v)^I.i(v);return new a(_,this.h^I.h)};function Me(I){const p=I.g.length+1,_=[];for(let v=0;v<p;v++)_[v]=I.i(v)<<1|I.i(v-1)>>>31;return new a(_,I.h)}function ye(I,p){const _=p>>5;p%=32;const v=I.g.length-_,E=[];for(let A=0;A<v;A++)E[A]=p>0?I.i(A+_)>>>p|I.i(A+_+1)<<32-p:I.i(A+_);return new a(E,I.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,ah=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=m,Rt=a}).apply(typeof sl<"u"?sl:typeof self<"u"?self:typeof window<"u"?window:{});var rs=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jy{constructor(e,t,r,s,o,a,l,h,d,m,g){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=o,this.forceLongPolling=a,this.autoDetectLongPolling=l,this.longPollingOptions=h,this.useFetchStreams=d,this.isUsingEmulator=m,this.apiKey=g}}const oo="(default)";class gr{constructor(e,t){this.projectId=e,this.database=t||oo}static empty(){return new gr("","")}get isDefaultDatabase(){return this.database===oo}isEqual(e){return e instanceof gr&&e.projectId===this.projectId&&e.database===this.database}}function qy(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new k(b.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new gr(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tE{constructor(){this.changes=new nn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ae.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?P.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iE{constructor(){this.overlays=new Z(x.comparator),this.Lr=new Map}getOverlay(e,t){return P.resolve(this.overlays.get(t))}getOverlays(e,t){const r=Wt();return P.forEach(t,s=>this.getOverlay(e,s).next(o=>{o!==null&&r.set(s,o)})).next(()=>r)}saveOverlays(e,t,r){return r.forEach((s,o)=>{this.St(e,t,o)}),P.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.Lr.get(r);return s!==void 0&&(s.forEach(o=>this.overlays=this.overlays.remove(o)),this.Lr.delete(r)),P.resolve()}getOverlaysForCollection(e,t,r){const s=Wt(),o=t.length+1,a=new x(t.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const h=l.getNext().value,d=h.getKey();if(!t.isPrefixOf(d.path))break;d.path.length===o&&h.largestBatchId>r&&s.set(h.getKey(),h)}return P.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let o=new Z((d,m)=>d-m);const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===t&&d.largestBatchId>r){let m=o.get(d.largestBatchId);m===null&&(m=Wt(),o=o.insert(d.largestBatchId,m)),m.set(d.getKey(),d)}}const l=Wt(),h=o.getIterator();for(;h.hasNext()&&(h.getNext().value.forEach((d,m)=>l.set(d,m)),!(l.size()>=s)););return P.resolve(l)}St(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.Lr.get(s.largestBatchId).delete(r.key);this.Lr.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new w_(t,r));let o=this.Lr.get(t);o===void 0&&(o=z(),this.Lr.set(t,o)),this.Lr.set(t,o.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oE{constructor(){this.sessionToken=Ie.EMPTY_BYTE_STRING}getSessionToken(e){return P.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,P.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fE{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=function(){return Zf()?8:My(Se())>0?6:4}()}initialize(e,t){this.fs=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.gs(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.ps(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new dE;return this.ys(e,t,a).next(l=>{if(o.result=l,this.As)return this.ws(e,t,a,l.size)})}).next(()=>o.result)}ws(e,t,r,s){return r.documentReadCount<this.Vs?(ln()<=H.DEBUG&&N("QueryEngine","SDK will not create cache indexes for query:",un(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),P.resolve()):(ln()<=H.DEBUG&&N("QueryEngine","Query:",un(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.ds*s?(ln()<=H.DEBUG&&N("QueryEngine","The SDK decides to create cache indexes for query:",un(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Ke(t))):P.resolve())}gs(e,t){if(Tl(t))return P.resolve(null);let r=Ke(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=fo(t,null,"F"),r=Ke(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=z(...o);return this.fs.getDocuments(e,a).next(l=>this.indexManager.getMinOffset(e,r).next(h=>{const d=this.Ss(t,l);return this.bs(t,d,a,h.readTime)?this.gs(e,fo(t,null,"F")):this.Ds(e,d,t,h)}))})))}ps(e,t,r,s){return Tl(t)||s.isEqual(U.min())?P.resolve(null):this.fs.getDocuments(e,r).next(o=>{const a=this.Ss(t,o);return this.bs(t,a,r,s)?P.resolve(null):(ln()<=H.DEBUG&&N("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),un(t)),this.Ds(e,a,t,Vy(s,mr)).next(l=>l))})}Ss(e,t){let r=new he(Oh(e));return t.forEach((s,o)=>{Js(e,o)&&(r=r.add(o))}),r}bs(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}ys(e,t,r){return ln()<=H.DEBUG&&N("QueryEngine","Using full collection scan to execute query:",un(t)),this.fs.getDocumentsMatchingQuery(e,t,Dt.min(),r)}Ds(e,t,r,s){return this.fs.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qi="RestConnection",SE={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class bE{get Ko(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.qo=t+"://"+e.host,this.Uo=`projects/${r}/databases/${s}`,this.$o=this.databaseId.database===oo?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Wo(e,t,r,s,o){const a=Eo(),l=this.Qo(e,t.toUriEncodedString());N(qi,`Sending RPC '${e}' ${a}:`,l,r);const h={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(h,s,o);const{host:d}=new URL(l),m=br(d);return this.zo(e,l,h,r,m).then(g=>(N(qi,`Received RPC '${e}' ${a}: `,g),g),g=>{throw en(qi,`RPC '${e}' ${a} failed with error: `,g,"url: ",l,"request:",r),g})}jo(e,t,r,s,o,a){return this.Wo(e,t,r,s,o)}Go(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+kn}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,o)=>e[o]=s),r&&r.headers.forEach((s,o)=>e[o]=s)}Qo(e,t){const r=SE[e];let s=`${this.qo}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Te="WebChannelConnection",Xn=(n,e,t)=>{n.listen(e,r=>{try{t(r)}catch(s){setTimeout(()=>{throw s},0)}})};class gn extends bE{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!gn.c_){const e=hh();Xn(e,uh.STAT_EVENT,t=>{t.stat===so.PROXY?N(Te,"STAT_EVENT: detected buffering proxy"):t.stat===so.NOPROXY&&N(Te,"STAT_EVENT: detected no buffering proxy")}),gn.c_=!0}}zo(e,t,r,s,o){const a=Eo();return new Promise((l,h)=>{const d=new ch;d.setWithCredentials(!0),d.listenOnce(lh.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case ds.NO_ERROR:const g=d.getResponseJson();N(Te,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(g)),l(g);break;case ds.TIMEOUT:N(Te,`RPC '${e}' ${a} timed out`),h(new k(b.DEADLINE_EXCEEDED,"Request time out"));break;case ds.HTTP_ERROR:const w=d.getStatus();if(N(Te,`RPC '${e}' ${a} failed with status:`,w,"response text:",d.getResponseText()),w>0){let R=d.getResponseJson();Array.isArray(R)&&(R=R[0]);const V=R?.error;if(V&&V.status&&V.message){const L=function(j){const W=j.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(W)>=0?W:b.UNKNOWN}(V.status);h(new k(L,V.message))}else h(new k(b.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new k(b.UNAVAILABLE,"Connection failed."));break;default:M(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{N(Te,`RPC '${e}' ${a} completed.`)}});const m=JSON.stringify(s);N(Te,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",m,r,15)})}T_(e,t,r){const s=Eo(),o=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(l.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Go(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const d=o.join("");N(Te,`Creating RPC '${e}' stream ${s}: ${d}`,l);const m=a.createWebChannel(d,l);this.I_(m);let g=!1,w=!1;const R=new RE({Jo:V=>{w?N(Te,`Not sending because RPC '${e}' stream ${s} is closed:`,V):(g||(N(Te,`Opening RPC '${e}' stream ${s} transport.`),m.open(),g=!0),N(Te,`RPC '${e}' stream ${s} sending:`,V),m.send(V))},Ho:()=>m.close()});return Xn(m,Zn.EventType.OPEN,()=>{w||(N(Te,`RPC '${e}' stream ${s} transport opened.`),R.i_())}),Xn(m,Zn.EventType.CLOSE,()=>{w||(w=!0,N(Te,`RPC '${e}' stream ${s} transport closed`),R.o_(),this.E_(m))}),Xn(m,Zn.EventType.ERROR,V=>{w||(w=!0,en(Te,`RPC '${e}' stream ${s} transport errored. Name:`,V.name,"Message:",V.message),R.o_(new k(b.UNAVAILABLE,"The operation could not be completed")))}),Xn(m,Zn.EventType.MESSAGE,V=>{if(!w){const L=V.data[0];K(!!L,16349);const C=L,j=C?.error||C[0]?.error;if(j){N(Te,`RPC '${e}' stream ${s} received error:`,j);const W=j.status;let ee=function(ye){const I=ie[ye];if(I!==void 0)return Gh(I)}(W),Ce=j.message;W==="NOT_FOUND"&&Ce.includes("database")&&Ce.includes("does not exist")&&Ce.includes(this.databaseId.database)&&en(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),ee===void 0&&(ee=b.INTERNAL,Ce="Unknown error status: "+W+" with message "+j.message),w=!0,R.o_(new k(ee,Ce)),m.close()}else N(Te,`RPC '${e}' stream ${s} received:`,L),R.__(L)}}),gn.u_(),setTimeout(()=>{R.s_()},0),R}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter(t=>t===e)}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return dh()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
Upgrade to Pro for unlimited scanning.`,"slip.viewSlip":"View slip ↗","slip.viewBtn":"View slip","cat.salary":"Salary","cat.freelance":"Freelance","cat.investment":"Investment","cat.gift":"Gift/Bonus","cat.other_in":"Other Income","cat.food":"Food","cat.transport":"Transport","cat.shopping":"Shopping","cat.utilities":"Utilities","cat.health":"Health","cat.entertainment":"Entertainment","cat.education":"Education","cat.rent":"Rent/Home","cat.other_ex":"Other Expense","dev.switchFree":"🔧 Dev: Pro → Switch Free","dev.switchPro":"🔧 Dev: Free → Switch Pro","dev.toasted":"🔧 Dev: Switched to "}};let ai=(()=>{const n=localStorage.getItem("mf_lang");return n==="th"||n==="en"?n:navigator.language?.toLowerCase().startsWith("th")?"th":"en"})();function Wi(){return ai}function QI(n){n!=="th"&&n!=="en"||(ai=n,localStorage.setItem("mf_lang",n))}function O(n,e){let t=su[ai]?.[n]??su.th[n]??n;if(e)for(const[r,s]of Object.entries(e))t=t.replaceAll(`{${r}}`,s);return t}function bn(){return O("locale")}function iu(){document.querySelectorAll("[data-i18n]").forEach(e=>{e.textContent=O(e.dataset.i18n)}),document.querySelectorAll("[data-i18n-html]").forEach(e=>{e.innerHTML=O(e.dataset.i18nHtml).replace(/\n/g,"<br>")}),document.querySelectorAll("[data-i18n-ph]").forEach(e=>{e.placeholder=O(e.dataset.i18nPh)});const n=document.getElementById("select-language");n&&(n.value=ai)}const vr={income:[{id:"salary",emoji:"💼"},{id:"freelance",emoji:"💻"},{id:"investment",emoji:"📈"},{id:"gift",emoji:"🎁"},{id:"other_in",emoji:"💰"}],expense:[{id:"food",emoji:"🍜"},{id:"transport",emoji:"🚗"},{id:"shopping",emoji:"🛍️"},{id:"utilities",emoji:"💡"},{id:"health",emoji:"🏥"},{id:"entertainment",emoji:"🎮"},{id:"education",emoji:"📚"},{id:"rent",emoji:"🏠"},{id:"other_ex",emoji:"📦"}]};function va(n){return O(`cat.${n}`)||n}const JI={income:["#22c55e","#16a34a","#86efac","#4ade80","#bbf7d0"],expense:["#f43f5e","#e11d48","#fb7185","#f97316","#fb923c","#fbbf24","#a855f7","#8b5cf6","#6366f1"]},YI=new Map([...vr.income,...vr.expense].map(n=>[n.id,n]));function XI(n){const e=YI.get(n);return e?{...e,label:va(n)}:{label:n,emoji:"📌"}}const ou="pkey_test_YOUR_OMISE_PUBLIC_KEY",Ms=5,lr=["nunmongss@gmail.com"];let ur=localStorage.getItem("mf_dev_plan")||"pro",ge=JSON.parse(localStorage.getItem("mf_cache_tx")||"[]"),Ta="income",_s=null,hr=null,rr="dashboard",it=parseInt(localStorage.getItem("mf_cutoff_day"))||1,Hd="list",Gd="cycle",Wd=null,Kd=null,Fs=null,et=null,pe=null,oe="free",wa=0,Aa="",ot=null;const Br=()=>AI(Ia,"users",pe.uid,"transactions"),Sa=()=>xr(Ia,"users",pe.uid),ZI=ge.length>0;ZI&&(Qd(),at("syncing"),Rn());og(Ea,n=>{if(n)pe=n,Qd(),nv(),Ca(),at("syncing"),ge.length>0&&Rn(),iv(),rv();else{pe=null,ot&&(ot(),ot=null),ge=[],oe="free";const e=document.getElementById("btn-dev-toggle");e&&(e.style.display="none"),ev()}});function ev(){document.getElementById("login-screen").style.display="flex",document.getElementById("app-wrapper").style.display="none",tn()}function Qd(){document.getElementById("login-screen").style.display="none",document.getElementById("app-wrapper").style.display=""}async function tv(){try{Us(O("loading.signingIn")),await Rg(Ea,GI)}catch(n){tn(),ne(O("toast.signInError")+n.message,"error")}}async function au(){ot&&(ot(),ot=null),await ag(Ea),localStorage.removeItem("mf_cache_tx")}function nv(){if(!pe)return;const n=document.getElementById("user-avatar"),e=document.getElementById("user-name");n&&(n.src=pe.photoURL||""),e&&(e.textContent=pe.displayName||pe.email||"");const t=document.getElementById("mobile-avatar"),r=document.getElementById("mobile-user-name");t&&(t.src=pe.photoURL||""),r&&(r.textContent=pe.displayName||pe.email||"")}function rv(){ot&&ot();const n=OI(Br(),xI("date","desc"));at("syncing"),ot=qI(n,e=>{ge=e.docs.map(t=>({id:t.id,...t.data()})),sv(),lv(),Rn(),at("online"),tn()},e=>{console.error("[Firestore] snapshot error:",e),at("offline"),tn(),ne("⚠️ Firestore error: "+e.message,"error",8e3)})}function sv(){const n=new Date;n.setDate(n.getDate()-90),ge.forEach(e=>{e.imageData&&new Date(e.createdAt)<n&&(e.imageData="",Jd(e.id,{imageData:""}).catch(()=>{}))})}async function iv(){try{const n=await jd(Sa());if(n.exists()){const e=n.data();e.cutoff_day&&(it=parseInt(e.cutoff_day)||1,localStorage.setItem("mf_cutoff_day",it)),wa=e.scan_count||0,Aa=e.scan_date||"",oe=lr.includes(pe?.email)?ur:e.plan||"free"}else lr.includes(pe?.email)&&(oe=ur);ci(),lr.includes(pe?.email)&&Ca()}catch(n){console.error("loadUserMeta error:",n)}}async function ba(n){await UI(Sa(),n,{merge:!0})}function ci(){const n=document.getElementById("plan-badge");n&&(n.textContent=oe==="pro"?"⭐ Pro":"Free",n.className="plan-badge "+oe);const e=document.getElementById("mobile-plan-badge");e&&(e.textContent=oe==="pro"?"⭐ Pro":"Free",e.className="plan-badge mobile-plan-badge "+oe);const t=document.getElementById("mobile-btn-updates");t&&(t.style.display=oe==="pro"?"none":"");const r=document.getElementById("btn-upgrade");r&&(r.style.display=oe==="pro"?"none":"");const s=document.getElementById("scan-info");if(s)if(oe==="pro")s.textContent=O("scan.pro"),s.className="scan-info-row pro";else{const o=new Date().toLocaleDateString("sv"),l=Ms-(Aa===o?wa:0);s.textContent=l>0?O("scan.free.left",{left:l,total:Ms}):O("scan.free.exhausted");const h=l<=0?"exhausted":l===1?"danger":l<=3?"warning":"";s.className=`scan-info-row${h?" "+h:""}`}}async function ov(n){at("syncing"),await jI(Br(),n)}async function Jd(n,e){at("syncing"),await BI(xr(Br(),n),e)}async function av(n){at("syncing"),await $I(xr(Br(),n))}async function cv(){if(oe==="pro")return!0;const n=new Date().toLocaleDateString("sv"),e=await jd(Sa()),t=e.exists()?e.data():{},s=t.scan_date===n&&t.scan_count||0;if(s>=Ms)return bo(O("scan.limit.upgrade",{total:Ms})),!1;const o=s+1;return await ba({scan_count:o,scan_date:n}),wa=o,Aa=n,ci(),!0}function Us(n){n===void 0&&(n=O("loading.default")),document.getElementById("loading-text").textContent=n,document.getElementById("loading-overlay").classList.add("active")}function tn(){document.getElementById("loading-overlay").classList.remove("active")}function at(n){const e=document.getElementById("sync-badge"),t=document.getElementById("sync-label");e.className="sync-badge "+n,t.textContent=O(`sync.${n}`)||n}function lv(){localStorage.setItem("mf_cache_tx",JSON.stringify(ge))}function Ge(n){return"฿"+Number(n).toLocaleString("th-TH",{minimumFractionDigits:2,maximumFractionDigits:2})}function Yd(n){const e=new Date(n);if(isNaN(e.getTime()))return n;const t=bn();return e.toLocaleDateString(t,{year:"numeric",month:"short",day:"numeric"})+" · "+e.toLocaleTimeString(t,{hour:"2-digit",minute:"2-digit"})}function Ra(n,e){return XI(e)}function Xd(n){const e=document.createElement("div");return e.appendChild(document.createTextNode(n)),e.innerHTML}function cu(n,e,t){const r=new Date(n,e+1,0).getDate();return new Date(n,e,Math.min(t,r))}function Pa(){const n=new Date,e=n.getFullYear(),t=n.getMonth();let r=cu(e,t,it);if(n.getDate()<it){const o=t===0?11:t-1,a=t===0?e-1:e;r=cu(a,o,it)}const s=new Date(r);return s.setMonth(s.getMonth()+1),{start:r,end:s}}function Zd(n){if(!n)return!1;const e=new Date(n);if(isNaN(e.getTime()))return!1;const{start:t,end:r}=Pa();return e>=t&&e<r}function uv(){let n=0,e=0;const{start:t,end:r}=Pa();ge.forEach(o=>{if(!o.date)return;const a=new Date(o.date);isNaN(a.getTime())||a<t||a>=r||(o.type==="income"?n+=Number(o.amount):e+=Number(o.amount))});const s=o=>Math.round(o*100)/100;return{income:s(n),expense:s(e),balance:s(n-e)}}let lu;function ne(n,e="success",t=3500){const r=document.getElementById("toast");r.textContent=n,r.className=`toast show ${e}`,clearTimeout(lu),lu=setTimeout(()=>{r.className="toast"},t)}function uu(n){rr=n,document.querySelectorAll(".view").forEach(r=>r.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(r=>r.classList.remove("active")),document.querySelectorAll(".bottom-nav-item").forEach(r=>r.classList.remove("active"));const e=document.getElementById(`view-${n}`);e&&e.classList.add("active");const t=document.getElementById(`nav-${n}`);t&&t.classList.add("active"),document.querySelectorAll(`.bottom-nav-item[data-view="${n}"]`).forEach(r=>r.classList.add("active")),document.getElementById("page-title").textContent=O(`page.${n}`)||n,Rn(),window.innerWidth<=900&&document.getElementById("sidebar").classList.remove("open")}function So(n){const e=document.getElementById("input-category");e.innerHTML="",vr[n].forEach(t=>{const r=document.createElement("option");r.value=t.id,r.textContent=`${t.emoji} ${va(t.id)}`,e.appendChild(r)})}function hu(){const n=document.getElementById("filter-category");n.innerHTML=`<option value="all">${O("tx.filterAllCats")}</option>`,[...vr.income,...vr.expense].forEach(e=>{const t=document.createElement("option");t.value=e.id,t.textContent=`${e.emoji} ${va(e.id)}`,n.appendChild(t)})}function hv(){const{income:n,expense:e,balance:t}=uv();document.getElementById("total-balance").textContent=Ge(t),document.getElementById("total-income").textContent=Ge(n),document.getElementById("total-expense").textContent=Ge(e);const r=n+e,s=r>0?e/r*100:0;document.getElementById("ratio-fill").style.width=s+"%",document.getElementById("ratio-income-label").textContent=`${O("dash.ratio.income")} ${(100-s).toFixed(0)}%`,document.getElementById("ratio-expense-label").textContent=`${O("dash.ratio.expense")} ${s.toFixed(0)}%`;const o=document.getElementById("balance-trend");t>0?o.textContent=O("dash.balance.positive"):t<0?o.textContent=O("dash.balance.negative"):o.textContent=O("dash.balance.zero");const a=[...ge].sort((l,h)=>new Date(h.date)-new Date(l.date)).slice(0,5);dv("recent-list",a,"empty-recent")}function dv(n,e,t){const r=document.getElementById(n);if(r.innerHTML="",e.length===0){const s=document.getElementById(t);s&&r.appendChild(s.cloneNode(!0));return}e.forEach(s=>{const o=Ra(s.type,s.category),a=!!s.imageData,l=document.createElement("div");l.className="transaction-item",l.innerHTML=`
      ...
      </div>`,r.appendChild(l)}),r.querySelectorAll(".tx-btn-edit").forEach(s=>s.addEventListener("click",()=>tf(s.dataset.id))),r.querySelectorAll(".tx-btn-delete").forEach(s=>s.addEventListener("click",()=>nf(s.dataset.id))),r.querySelectorAll(".tx-image-btn").forEach(s=>s.addEventListener("click",()=>ef(s.dataset.id)))}function ef(n){const e=ge.find(r=>r.id===n);if(!e?.imageData)return;const t=document.getElementById("slip-lightbox");document.getElementById("slip-lightbox-img").src=e.imageData,t.classList.add("active")}function du(n){Hd=n;const e=n==="split";document.getElementById("tx-list-view").style.display=e?"none":"",document.getElementById("tx-split-view").style.display=e?"":"none",document.getElementById("filter-type").style.display=e?"none":"",document.getElementById("btn-view-list").classList.toggle("active",!e),document.getElementById("btn-view-split").classList.toggle("active",e),Tr()}function fv(n,e){const t=document.getElementById("scale-beam"),r=document.getElementById("scale-pan-left"),s=document.getElementById("scale-pan-right"),o=document.getElementById("scale-verdict"),a=document.getElementById("scale-income-total"),l=document.getElementById("scale-expense-total");if(!t)return;const h=n.reduce((w,R)=>w+Number(R.amount),0),d=e.reduce((w,R)=>w+Number(R.amount),0),m=h+d,g=m>0?(d-h)/m*22:0;if(t.style.transform=`rotate(${g}deg)`,r.classList.toggle("heavy",h>d),s.classList.toggle("heavy",d>h),a&&(a.textContent=Ge(h)),l&&(l.textContent=Ge(d)),o){const w=Math.abs(h-d);m===0?(o.textContent=O("tx.scale.noItems"),o.className="scale-verdict"):h>d?(o.textContent=`+${Ge(w)}`,o.className="scale-verdict positive"):d>h?(o.textContent=`-${Ge(w)}`,o.className="scale-verdict negative"):(o.textContent=O("tx.scale.equal"),o.className="scale-verdict")}}function fu(n){Gd=n,document.getElementById("btn-range-all").classList.toggle("active",n==="all"),document.getElementById("btn-range-cycle").classList.toggle("active",n==="cycle"),Tr()}function Ki(n){return Gd!=="cycle"?n:n.filter(e=>Zd(e.date))}function Tr(){const n=document.getElementById("filter-category").value;if(Hd==="split"){let e=Ki(ge.filter(r=>r.type==="income")).sort((r,s)=>new Date(s.date)-new Date(r.date)),t=Ki(ge.filter(r=>r.type==="expense")).sort((r,s)=>new Date(s.date)-new Date(r.date));n!=="all"&&(e=e.filter(r=>r.category===n),t=t.filter(r=>r.category===n)),fv(e,t),Qi("split-income-list",e,"empty-split-income"),Qi("split-expense-list",t,"empty-split-expense")}else{const e=document.getElementById("filter-type").value;let t=Ki([...ge]).sort((r,s)=>new Date(s.date)-new Date(r.date));e!=="all"&&(t=t.filter(r=>r.type===e)),n!=="all"&&(t=t.filter(r=>r.category===n)),Qi("all-list",t,"empty-all")}}function Qi(n,e,t){const r=document.getElementById(n);if(!r)return;if(r.innerHTML="",e.length===0){const o=document.getElementById(t);o?r.appendChild(o.cloneNode(!0)):r.innerHTML=`<div class="empty-state"><div class="empty-icon">📋</div><p>${O("tx.noItems")}</p></div>`;return}let s=null;e.forEach(o=>{const a=o.date?o.date.slice(0,10):"";if(a!==s){s=a;const g=document.createElement("div");g.className="timeline-date-header";const w=new Date(a+"T00:00:00");g.textContent=isNaN(w)?a:w.toLocaleDateString(bn(),{weekday:"short",year:"numeric",month:"short",day:"numeric"}),r.appendChild(g)}const l=Ra(o.type,o.category),h=document.createElement("div");h.className="transaction-item";const d=!!o.imageData,m=oe==="pro"&&d;h.innerHTML=`
